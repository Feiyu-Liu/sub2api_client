...
void main() {
  test('Admin and Ops expose isolated typed management facades', () {
    ...
    final Sub2ApiAdminGrokOAuthClient adminGrokOAuth = admin.grokOAuth;
    final Sub2ApiAdminGrokOAuthClient opsGrokOAuth = ops.grokOAuth;
    ...
    final Sub2ApiAdminRedeemCodesClient adminRedeemCodes = admin.redeemCodes;
    final Sub2ApiAdminRedeemCodesClient opsRedeemCodes = ops.redeemCodes;
