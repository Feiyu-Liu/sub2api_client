...
| [ADR-0003](0003-v0-1-package-scope-and-dependencies.md) | Accepted（Admin/Ops 范围由 0008 替代；部分工程计划由 0005 替代） | v0.1 首版只实现用户端；采用 Dio、条件 Retrofit、json_serializable、Freezed 3.2.5、decimal 和手写敏感类型 |
...
| [ADR-0008](0008-complete-management-plane-and-isolate-credential-surfaces.md) | Accepted | 完成用户与 Admin/Ops 管理业务面，隔离 JWT、Admin API Key 和 Gateway 凭证入口，并建立分阶段完成标准 |
