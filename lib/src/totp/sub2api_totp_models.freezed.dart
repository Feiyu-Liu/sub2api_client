...
mixin _$Sub2ApiTotpStatus {
  ...
  $Sub2ApiTotpStatusCopyWith<Sub2ApiTotpStatus> get copyWith =>
      _$Sub2ApiTotpStatusCopyWithImpl<Sub2ApiTotpStatus>(
        this as Sub2ApiTotpStatus,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is Sub2ApiTotpStatus &&
            (identical(other.enabled, enabled) || other.enabled == enabled) &&
            (identical(other.featureEnabled, featureEnabled) ||
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, enabled, featureEnabled, enabledAt);
...
abstract mixin class $Sub2ApiTotpStatusCopyWith<$Res> {
  factory $Sub2ApiTotpStatusCopyWith(
    Sub2ApiTotpStatus value,
    $Res Function(Sub2ApiTotpStatus) _then,
  ) = _$Sub2ApiTotpStatusCopyWithImpl;
  @useResult
  $Res call({bool enabled, bool featureEnabled, DateTime? enabledAt});
}
      ...
      _self.copyWith(
        enabled: null == enabled
            ...
            : enabled // ignore: cast_nullable_to_non_nullable
                  as bool,
        featureEnabled: null == featureEnabled
            ? _self.featureEnabled
            : featureEnabled // ignore: cast_nullable_to_non_nullable
                  as bool,
...
extension Sub2ApiTotpStatusPatterns on Sub2ApiTotpStatus {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Sub2ApiTotpStatus value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool enabled, bool featureEnabled, DateTime? enabledAt)?
    $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Sub2ApiTotpStatus() when $default != null:
        return $default(_that.enabled, _that.featureEnabled, _that.enabledAt);
      case _:
        return orElse();
    }
  }
...
class _Sub2ApiTotpStatus implements Sub2ApiTotpStatus {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$Sub2ApiTotpStatusCopyWith<_Sub2ApiTotpStatus> get copyWith =>
      __$Sub2ApiTotpStatusCopyWithImpl<_Sub2ApiTotpStatus>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _Sub2ApiTotpStatus &&
            (identical(other.enabled, enabled) || other.enabled == enabled) &&
            (identical(other.featureEnabled, featureEnabled) ||
                other.featureEnabled == featureEnabled) &&
            (identical(other.enabledAt, enabledAt) ||
...
/// @nodoc
abstract mixin class _$Sub2ApiTotpStatusCopyWith<$Res>
    implements $Sub2ApiTotpStatusCopyWith<$Res> {
  factory _$Sub2ApiTotpStatusCopyWith(
    _Sub2ApiTotpStatus value,
    $Res Function(_Sub2ApiTotpStatus) _then,
  ) = __$Sub2ApiTotpStatusCopyWithImpl;
  @override
  @useResult
  $Res call({bool enabled, bool featureEnabled, DateTime? enabledAt});
}
...
mixin _$Sub2ApiTotpStepUpGrant {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $Sub2ApiTotpStepUpGrantCopyWith<Sub2ApiTotpStepUpGrant> get copyWith =>
      _$Sub2ApiTotpStepUpGrantCopyWithImpl<Sub2ApiTotpStepUpGrant>(
        this as Sub2ApiTotpStepUpGrant,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is Sub2ApiTotpStepUpGrant &&
...
abstract mixin class $Sub2ApiTotpStepUpGrantCopyWith<$Res> {
  factory $Sub2ApiTotpStepUpGrantCopyWith(
    Sub2ApiTotpStepUpGrant value,
    $Res Function(Sub2ApiTotpStepUpGrant) _then,
  ) = _$Sub2ApiTotpStepUpGrantCopyWithImpl;
  @useResult
  $Res call({bool verified, Duration expiresIn});
}
...
class _$Sub2ApiTotpStepUpGrantCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? verified = null, Object? expiresIn = null}) {
    return _then(
      _self.copyWith(
...
extension Sub2ApiTotpStepUpGrantPatterns on Sub2ApiTotpStepUpGrant {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Sub2ApiTotpStepUpGrant value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool verified, Duration expiresIn)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Sub2ApiTotpStepUpGrant() when $default != null:
        return $default(_that.verified, _that.expiresIn);
      case _:
        return orElse();
    }
  }
...
class _Sub2ApiTotpStepUpGrant implements Sub2ApiTotpStepUpGrant {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$Sub2ApiTotpStepUpGrantCopyWith<_Sub2ApiTotpStepUpGrant> get copyWith =>
      __$Sub2ApiTotpStepUpGrantCopyWithImpl<_Sub2ApiTotpStepUpGrant>(
        this,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _Sub2ApiTotpStepUpGrant &&
            (identical(other.verified, verified) ||
                other.verified == verified) &&
            (identical(other.expiresIn, expiresIn) ||
                other.expiresIn == expiresIn));
...
/// @nodoc
abstract mixin class _$Sub2ApiTotpStepUpGrantCopyWith<$Res>
    implements $Sub2ApiTotpStepUpGrantCopyWith<$Res> {
  factory _$Sub2ApiTotpStepUpGrantCopyWith(
    _Sub2ApiTotpStepUpGrant value,
    $Res Function(_Sub2ApiTotpStepUpGrant) _then,
  ) = __$Sub2ApiTotpStepUpGrantCopyWithImpl;
  @override
  @useResult
  $Res call({bool verified, Duration expiresIn});
}
