...
import 'sub2api_admin_backups_client.dart';
...
import 'sub2api_admin_data_management_client.dart';
...
import 'sub2api_admin_settings_client.dart';
...
final class Sub2ApiOpsClient {
  ...
  final Sub2ApiAdminBackupsClient backups;
  ...
  final Sub2ApiAdminDataManagementClient dataManagement;
  ...
  final Sub2ApiAdminSettingsClient settings;
...
Sub2ApiOpsClient _create({
  ...
  return Sub2ApiOpsClient._(
    ...
    backups: createSub2ApiAdminBackupsClient(
      dio: dio,
      requestExecutor: executor,
      credentialMode: Sub2ApiAdminCredentialMode.apiKey,
    ),
    ...
    dataManagement: createSub2ApiAdminDataManagementClient(
      dio: dio,
      requestExecutor: executor,
      credentialMode: Sub2ApiAdminCredentialMode.apiKey,
    ),
    ...
    operationsObservability: createSub2ApiAdminOpsObservabilityClient(
      dio: dio,
      requestExecutor: executor,
      credentialMode: Sub2ApiAdminCredentialMode.apiKey,
    ),
    ...
    paymentCatalog: createSub2ApiAdminPaymentCatalogClient(
      dio: dio,
      requestExecutor: executor,
      createdMutationExecutor: executor,
      credentialMode: Sub2ApiAdminCredentialMode.apiKey,
    ),
    ...
    settings: createSub2ApiAdminSettingsClient(
      dio: dio,
      requestExecutor: executor,
      credentialMode: Sub2ApiAdminCredentialMode.apiKey,
    ),
