...
part of 'admin_system_wire_service.dart';
...
class _AdminSystemWireService implements AdminSystemWireService {
  _AdminSystemWireService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<Object?>> rollbackVersions(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/system/rollback-versions',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
