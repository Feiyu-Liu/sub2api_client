...
part of 'admin_promo_code_wire_service.dart';
...
class _AdminPromoCodeWireService implements AdminPromoCodeWireService {
  _AdminPromoCodeWireService(this._dio, {this.baseUrl, this.errorLogger});
