...
part of 'admin_group_wire_service.dart';
...
class _AdminGroupWireService implements AdminGroupWireService {
  _AdminGroupWireService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<Object?>> modelsListCandidates(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/groups/${groupId}/models-list-candidates',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> groupStats(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/groups/${groupId}/stats',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> rateMultipliers(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/groups/${groupId}/rate-multipliers',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> apiKeys(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/groups/${groupId}/api-keys',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> previewCompositeRoute(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/groups/${groupId}/composite-routes/preview',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> duplicateGroup(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/groups/${groupId}/duplicate',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> setRpmOverrides(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/groups/${groupId}/rpm-overrides',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> groupSubscriptions(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/groups/${groupId}/subscriptions',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
