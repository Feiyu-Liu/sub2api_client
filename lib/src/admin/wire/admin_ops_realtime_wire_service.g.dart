...
part of 'admin_ops_realtime_wire_service.dart';
...
class _AdminOpsRealtimeWireService implements AdminOpsRealtimeWireService {
  _AdminOpsRealtimeWireService(this._dio, {this.baseUrl, this.errorLogger});
