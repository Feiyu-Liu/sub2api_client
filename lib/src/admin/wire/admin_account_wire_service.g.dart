...
class _AdminAccountWireService implements AdminAccountWireService {
  ...
  Future<HttpResponse<Object?>> applyOAuthCredentials(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/apply-oauth-credentials',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> duplicateAccount(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/duplicate',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> batchRefreshAccountCredentials(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/batch-refresh',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> refreshAccountCredentials(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/refresh',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> refreshAccountTier(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/refresh-tier',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> createShadow(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${parentAccountId}/shadow',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> generateOAuthAuthorization(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/generate-auth-url',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> generateSetupTokenAuthorization(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/generate-setup-token-url',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> exchangeOAuthCode(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/exchange-code',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> exchangeSetupTokenCode(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/exchange-setup-token-code',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> setUpstreamBillingProbeEnabled(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/upstream-billing-probe',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> saveOllamaCloudUsageSession(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/ollama-cloud-usage/session',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> setOllamaCloudUsageAutoRefresh(
    ...
    final _options = newOptions.copyWith(
      ...
      queryParameters: queryParameters,
      path:
          '/api/v1/admin/accounts/${accountId}/ollama-cloud-usage/auto-refresh',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> refreshOllamaCloudUsage(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/ollama-cloud-usage/refresh',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> recoverAccountState(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/recover-state',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> clearAccountError(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/clear-error',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> revertAccountProxyFallback(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/revert-proxy-fallback',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> clearAccountRateLimit(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/clear-rate-limit',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> resetAccountQuota(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/reset-quota',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> setAccountSchedulable(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/schedulable',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> setAccountPrivacy(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/set-privacy',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
  ...
  Future<HttpResponse<Object?>> syncUpstreamModels(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/admin/accounts/${accountId}/models/sync-upstream',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
