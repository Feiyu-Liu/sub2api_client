...
part of 'admin_plugin_wire_service.dart';
...
class _AdminPluginWireService implements AdminPluginWireService {
  _AdminPluginWireService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<Object?>> upload(
    ...
    _data.files.add(MapEntry('plugin', plugin));
    final newOptions = newRequestOptions(options);
    newOptions.extra.addAll(_extra);
    newOptions.headers.addAll(_dio.options.headers);
    newOptions.headers.addAll(_headers);
