...
part of 'admin_error_passthrough_wire_service.dart';
...
class _AdminErrorPassthroughWireService
    implements AdminErrorPassthroughWireService {
  ...
  Future<HttpResponse<Object?>> list(
    ...
    final _options = newOptions.copyWith(
      ...
      path: '/api/v1/admin/error-passthrough-rules',
    )..data = _data;
