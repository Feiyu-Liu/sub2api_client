...
part of 'admin_channel_wire_service.dart';
...
class _AdminChannelWireService implements AdminChannelWireService {
  _AdminChannelWireService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<HttpResponse<Object?>> modelPricing(
    String model,
    CancelToken cancelToken,
    Options options,
    String? authorization,
  ...
  @override
  Future<HttpResponse<Object?>> syncModels(
    String platform,
    CancelToken cancelToken,
    Options options,
    String? authorization,
