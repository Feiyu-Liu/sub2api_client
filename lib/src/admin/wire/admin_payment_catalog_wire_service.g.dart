...
part of 'admin_payment_catalog_wire_service.dart';
...
class _AdminPaymentCatalogWireService
    implements AdminPaymentCatalogWireService {
  _AdminPaymentCatalogWireService(this._dio, {this.baseUrl, this.errorLogger});
