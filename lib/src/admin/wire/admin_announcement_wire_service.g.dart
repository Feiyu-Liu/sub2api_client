...
part of 'admin_announcement_wire_service.dart';
...
class _AdminAnnouncementWireService implements AdminAnnouncementWireService {
  _AdminAnnouncementWireService(this._dio, {this.baseUrl, this.errorLogger});
