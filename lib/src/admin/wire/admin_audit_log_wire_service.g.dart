...
part of 'admin_audit_log_wire_service.dart';
...
class _AdminAuditLogWireService implements AdminAuditLogWireService {
  _AdminAuditLogWireService(this._dio, {this.baseUrl, this.errorLogger});
