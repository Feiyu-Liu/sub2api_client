...
part of 'admin_setting_wire_service.dart';
...
class _AdminSettingWireService implements AdminSettingWireService {
  _AdminSettingWireService(this._dio, {this.baseUrl, this.errorLogger});
