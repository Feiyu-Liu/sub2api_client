...
part of 'admin_payment_order_wire_service.dart';
...
class _AdminPaymentOrderWireService implements AdminPaymentOrderWireService {
  _AdminPaymentOrderWireService(this._dio, {this.baseUrl, this.errorLogger});
