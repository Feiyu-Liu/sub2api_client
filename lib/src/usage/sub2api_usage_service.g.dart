...
part of 'sub2api_usage_service.dart';
...
class _Sub2ApiUsageService implements Sub2ApiUsageService {
  _Sub2ApiUsageService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<Object?>> list(
    ...
    final queryParameters = <String, dynamic>{
      ...
      r'stream': stream,
      r'billing_type': billingType,
      r'billing_mode': billingMode,
  ...
  Future<HttpResponse<Object?>> dashboardApiKeysUsage(
    Sub2ApiUsageApiKeysRequestDto body,
    CancelToken cancelToken,
    Options options,
    String? authorization,
  ) async {
