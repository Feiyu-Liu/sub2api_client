...
mixin _$Sub2ApiUsageErrorQuery {
 ...
 int get page; int get pageSize; DateTime? get startDate; DateTime? get endDate; String? get timezone; String? get model; int? get statusCode; String? get category; int? get apiKeyId; String get sortBy; String get sortOrder;
/// Create a copy of Sub2ApiUsageErrorQuery
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Sub2ApiUsageErrorQueryCopyWith<Sub2ApiUsageErrorQuery> get copyWith => _$Sub2ApiUsageErrorQueryCopyWithImpl<Sub2ApiUsageErrorQuery>(this as Sub2ApiUsageErrorQuery, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sub2ApiUsageErrorQuery&&(identical(other.page, page) || other.page == page)&&(identical(other.pageSize, pageSize) || other.pageSize == pageSize)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.timezone, timezone) || other.timezone == timezone)&&(identical(other.model, model) || other.model == model)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.category, category) || other.category == category)&&(identical(other.apiKeyId, apiKeyId) || other.apiKeyId == apiKeyId)&&(identical(other.sortBy, sortBy) || other.sortBy == sortBy)&&(identical(other.sortOrder, sortOrder) || other.sortOrder == sortOrder));
}


@override
int get hashCode => Object.hash(runtimeType,page,pageSize,startDate,endDate,timezone,model,statusCode,category,apiKeyId,sortBy,sortOrder);
...
abstract mixin class $Sub2ApiUsageErrorQueryCopyWith<$Res>  {
  factory $Sub2ApiUsageErrorQueryCopyWith(Sub2ApiUsageErrorQuery value, $Res Function(Sub2ApiUsageErrorQuery) _then) = _$Sub2ApiUsageErrorQueryCopyWithImpl;
@useResult
$Res call({
 int page, int pageSize, DateTime? startDate, DateTime? endDate, String? timezone, String? model, int? statusCode, String? category, int? apiKeyId, String sortBy, String sortOrder
});
...
/// Create a copy of Sub2ApiUsageErrorQuery
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? page = null,Object? pageSize = null,Object? startDate = freezed,Object? endDate = freezed,Object? timezone = freezed,Object? model = freezed,Object? statusCode = freezed,Object? category = freezed,Object? apiKeyId = freezed,Object? sortBy = null,Object? sortOrder = null,}) {
  return _then(_self.copyWith(
page: null == page ? _self.page : page // ignore: cast_nullable_to_non_nullable
as int,pageSize: null == pageSize ? _self.pageSize : pageSize // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsageErrorQuery value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsageErrorQuery value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsageErrorQuery value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsageErrorQuery() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int page,  int pageSize,  DateTime? startDate,  DateTime? endDate,  String? timezone,  String? model,  int? statusCode,  String? category,  int? apiKeyId,  String sortBy,  String sortOrder)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sub2ApiUsageErrorQuery() when $default != null:
return $default(_that.page,_that.pageSize,_that.startDate,_that.endDate,_that.timezone,_that.model,_that.statusCode,_that.category,_that.apiKeyId,_that.sortBy,_that.sortOrder);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int page,  int pageSize,  DateTime? startDate,  DateTime? endDate,  String? timezone,  String? model,  int? statusCode,  String? category,  int? apiKeyId,  String sortBy,  String sortOrder)  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageErrorQuery():
return $default(_that.page,_that.pageSize,_that.startDate,_that.endDate,_that.timezone,_that.model,_that.statusCode,_that.category,_that.apiKeyId,_that.sortBy,_that.sortOrder);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int page,  int pageSize,  DateTime? startDate,  DateTime? endDate,  String? timezone,  String? model,  int? statusCode,  String? category,  int? apiKeyId,  String sortBy,  String sortOrder)?  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageErrorQuery() when $default != null:
return $default(_that.page,_that.pageSize,_that.startDate,_that.endDate,_that.timezone,_that.model,_that.statusCode,_that.category,_that.apiKeyId,_that.sortBy,_that.sortOrder);case _:
  return null;
...
class _Sub2ApiUsageErrorQuery implements Sub2ApiUsageErrorQuery {
  const _Sub2ApiUsageErrorQuery({this.page = 1, this.pageSize = 20, this.startDate, this.endDate, this.timezone, this.model, this.statusCode, this.category, this.apiKeyId, this.sortBy = 'created_at', this.sortOrder = 'desc'});
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsageErrorQueryCopyWith<_Sub2ApiUsageErrorQuery> get copyWith => __$Sub2ApiUsageErrorQueryCopyWithImpl<_Sub2ApiUsageErrorQuery>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsageErrorQuery&&(identical(other.page, page) || other.page == page)&&(identical(other.pageSize, pageSize) || other.pageSize == pageSize)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.timezone, timezone) || other.timezone == timezone)&&(identical(other.model, model) || other.model == model)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.category, category) || other.category == category)&&(identical(other.apiKeyId, apiKeyId) || other.apiKeyId == apiKeyId)&&(identical(other.sortBy, sortBy) || other.sortBy == sortBy)&&(identical(other.sortOrder, sortOrder) || other.sortOrder == sortOrder));
}
...
/// @nodoc
abstract mixin class _$Sub2ApiUsageErrorQueryCopyWith<$Res> implements $Sub2ApiUsageErrorQueryCopyWith<$Res> {
  factory _$Sub2ApiUsageErrorQueryCopyWith(_Sub2ApiUsageErrorQuery value, $Res Function(_Sub2ApiUsageErrorQuery) _then) = __$Sub2ApiUsageErrorQueryCopyWithImpl;
@override @useResult
$Res call({
 int page, int pageSize, DateTime? startDate, DateTime? endDate, String? timezone, String? model, int? statusCode, String? category, int? apiKeyId, String sortBy, String sortOrder
});
...
/// Create a copy of Sub2ApiUsageErrorQuery
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? page = null,Object? pageSize = null,Object? startDate = freezed,Object? endDate = freezed,Object? timezone = freezed,Object? model = freezed,Object? statusCode = freezed,Object? category = freezed,Object? apiKeyId = freezed,Object? sortBy = null,Object? sortOrder = null,}) {
  return _then(_Sub2ApiUsageErrorQuery(
page: null == page ? _self.page : page // ignore: cast_nullable_to_non_nullable
as int,pageSize: null == pageSize ? _self.pageSize : pageSize // ignore: cast_nullable_to_non_nullable
as int,startDate: freezed == startDate ? _self.startDate : startDate // ignore: cast_nullable_to_non_nullable
as DateTime?,endDate: freezed == endDate ? _self.endDate : endDate // ignore: cast_nullable_to_non_nullable
...
mixin _$Sub2ApiUsageError {
 ...
 int get id; DateTime get createdAt; String get model; String get inboundEndpoint; int get statusCode; String get category; String get platform; String get message; String get keyName; bool get keyDeleted; String? get clientIp; String? get groupName; int? get requestType; bool get stream; String? get userAgent;
/// Create a copy of Sub2ApiUsageError
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Sub2ApiUsageErrorCopyWith<Sub2ApiUsageError> get copyWith => _$Sub2ApiUsageErrorCopyWithImpl<Sub2ApiUsageError>(this as Sub2ApiUsageError, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sub2ApiUsageError&&(identical(other.id, id) || other.id == id)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.model, model) || other.model == model)&&(identical(other.inboundEndpoint, inboundEndpoint) || other.inboundEndpoint == inboundEndpoint)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.category, category) || other.category == category)&&(identical(other.platform, platform) || other.platform == platform)&&(identical(other.message, message) || other.message == message)&&(identical(other.keyName, keyName) || other.keyName == keyName)&&(identical(other.keyDeleted, keyDeleted) || other.keyDeleted == keyDeleted)&&(identical(other.clientIp, clientIp) || other.clientIp == clientIp)&&(identical(other.groupName, groupName) || other.groupName == groupName)&&(identical(other.requestType, requestType) || other.requestType == requestType)&&(identical(other.stream, stream) || other.stream == stream)&&(identical(other.userAgent, userAgent) || other.userAgent == userAgent));
}


@override
int get hashCode => Object.hash(runtimeType,id,createdAt,model,inboundEndpoint,statusCode,category,platform,message,keyName,keyDeleted,clientIp,groupName,requestType,stream,userAgent);
...
abstract mixin class $Sub2ApiUsageErrorCopyWith<$Res>  {
  factory $Sub2ApiUsageErrorCopyWith(Sub2ApiUsageError value, $Res Function(Sub2ApiUsageError) _then) = _$Sub2ApiUsageErrorCopyWithImpl;
@useResult
$Res call({
 int id, DateTime createdAt, String model, String inboundEndpoint, int statusCode, String category, String platform, String message, String keyName, bool keyDeleted, String? clientIp, String? groupName, int? requestType, bool stream, String? userAgent
});
...
/// Create a copy of Sub2ApiUsageError
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? createdAt = null,Object? model = null,Object? inboundEndpoint = null,Object? statusCode = null,Object? category = null,Object? platform = null,Object? message = null,Object? keyName = null,Object? keyDeleted = null,Object? clientIp = freezed,Object? groupName = freezed,Object? requestType = freezed,Object? stream = null,Object? userAgent = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,model: null == model ? _self.model : model // ignore: cast_nullable_to_non_nullable
as String,inboundEndpoint: null == inboundEndpoint ? _self.inboundEndpoint : inboundEndpoint // ignore: cast_nullable_to_non_nullable
...
as String,keyDeleted: null == keyDeleted ? _self.keyDeleted : keyDeleted // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsageError value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsageError value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsageError value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsageError() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  DateTime createdAt,  String model,  String inboundEndpoint,  int statusCode,  String category,  String platform,  String message,  String keyName,  bool keyDeleted,  String? clientIp,  String? groupName,  int? requestType,  bool stream,  String? userAgent)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sub2ApiUsageError() when $default != null:
return $default(_that.id,_that.createdAt,_that.model,_that.inboundEndpoint,_that.statusCode,_that.category,_that.platform,_that.message,_that.keyName,_that.keyDeleted,_that.clientIp,_that.groupName,_that.requestType,_that.stream,_that.userAgent);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  DateTime createdAt,  String model,  String inboundEndpoint,  int statusCode,  String category,  String platform,  String message,  String keyName,  bool keyDeleted,  String? clientIp,  String? groupName,  int? requestType,  bool stream,  String? userAgent)  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageError():
return $default(_that.id,_that.createdAt,_that.model,_that.inboundEndpoint,_that.statusCode,_that.category,_that.platform,_that.message,_that.keyName,_that.keyDeleted,_that.clientIp,_that.groupName,_that.requestType,_that.stream,_that.userAgent);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  DateTime createdAt,  String model,  String inboundEndpoint,  int statusCode,  String category,  String platform,  String message,  String keyName,  bool keyDeleted,  String? clientIp,  String? groupName,  int? requestType,  bool stream,  String? userAgent)?  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageError() when $default != null:
return $default(_that.id,_that.createdAt,_that.model,_that.inboundEndpoint,_that.statusCode,_that.category,_that.platform,_that.message,_that.keyName,_that.keyDeleted,_that.clientIp,_that.groupName,_that.requestType,_that.stream,_that.userAgent);case _:
  return null;
...
class _Sub2ApiUsageError implements Sub2ApiUsageError {
  const _Sub2ApiUsageError({required this.id, required this.createdAt, required this.model, required this.inboundEndpoint, required this.statusCode, required this.category, required this.platform, required this.message, required this.keyName, required this.keyDeleted, this.clientIp, this.groupName, this.requestType, required this.stream, this.userAgent});
...
@override final  bool keyDeleted;
@override final  String? clientIp;
@override final  String? groupName;
@override final  int? requestType;
@override final  bool stream;
@override final  String? userAgent;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsageErrorCopyWith<_Sub2ApiUsageError> get copyWith => __$Sub2ApiUsageErrorCopyWithImpl<_Sub2ApiUsageError>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsageError&&(identical(other.id, id) || other.id == id)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.model, model) || other.model == model)&&(identical(other.inboundEndpoint, inboundEndpoint) || other.inboundEndpoint == inboundEndpoint)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.category, category) || other.category == category)&&(identical(other.platform, platform) || other.platform == platform)&&(identical(other.message, message) || other.message == message)&&(identical(other.keyName, keyName) || other.keyName == keyName)&&(identical(other.keyDeleted, keyDeleted) || other.keyDeleted == keyDeleted)&&(identical(other.clientIp, clientIp) || other.clientIp == clientIp)&&(identical(other.groupName, groupName) || other.groupName == groupName)&&(identical(other.requestType, requestType) || other.requestType == requestType)&&(identical(other.stream, stream) || other.stream == stream)&&(identical(other.userAgent, userAgent) || other.userAgent == userAgent));
}
...
/// @nodoc
abstract mixin class _$Sub2ApiUsageErrorCopyWith<$Res> implements $Sub2ApiUsageErrorCopyWith<$Res> {
  factory _$Sub2ApiUsageErrorCopyWith(_Sub2ApiUsageError value, $Res Function(_Sub2ApiUsageError) _then) = __$Sub2ApiUsageErrorCopyWithImpl;
@override @useResult
$Res call({
 int id, DateTime createdAt, String model, String inboundEndpoint, int statusCode, String category, String platform, String message, String keyName, bool keyDeleted, String? clientIp, String? groupName, int? requestType, bool stream, String? userAgent
});
...
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? createdAt = null,Object? model = null,Object? inboundEndpoint = null,Object? statusCode = null,Object? category = null,Object? platform = null,Object? message = null,Object? keyName = null,Object? keyDeleted = null,Object? clientIp = freezed,Object? groupName = freezed,Object? requestType = freezed,Object? stream = null,Object? userAgent = freezed,}) {
  return _then(_Sub2ApiUsageError(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,model: null == model ? _self.model : model // ignore: cast_nullable_to_non_nullable
as String,inboundEndpoint: null == inboundEndpoint ? _self.inboundEndpoint : inboundEndpoint // ignore: cast_nullable_to_non_nullable
...
mixin _$Sub2ApiUsageErrorDetail {
 ...
 Sub2ApiUsageError get summary; String get errorBody; int? get upstreamStatusCode;
/// Create a copy of Sub2ApiUsageErrorDetail
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Sub2ApiUsageErrorDetailCopyWith<Sub2ApiUsageErrorDetail> get copyWith => _$Sub2ApiUsageErrorDetailCopyWithImpl<Sub2ApiUsageErrorDetail>(this as Sub2ApiUsageErrorDetail, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sub2ApiUsageErrorDetail&&(identical(other.summary, summary) || other.summary == summary)&&(identical(other.errorBody, errorBody) || other.errorBody == errorBody)&&(identical(other.upstreamStatusCode, upstreamStatusCode) || other.upstreamStatusCode == upstreamStatusCode));
}


@override
int get hashCode => Object.hash(runtimeType,summary,errorBody,upstreamStatusCode);
...
abstract mixin class $Sub2ApiUsageErrorDetailCopyWith<$Res>  {
  factory $Sub2ApiUsageErrorDetailCopyWith(Sub2ApiUsageErrorDetail value, $Res Function(Sub2ApiUsageErrorDetail) _then) = _$Sub2ApiUsageErrorDetailCopyWithImpl;
@useResult
$Res call({
 Sub2ApiUsageError summary, String errorBody, int? upstreamStatusCode
});
...
/// Create a copy of Sub2ApiUsageErrorDetail
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? summary = null,Object? errorBody = null,Object? upstreamStatusCode = freezed,}) {
  return _then(_self.copyWith(
summary: null == summary ? _self.summary : summary // ignore: cast_nullable_to_non_nullable
as Sub2ApiUsageError,errorBody: null == errorBody ? _self.errorBody : errorBody // ignore: cast_nullable_to_non_nullable
as String,upstreamStatusCode: freezed == upstreamStatusCode ? _self.upstreamStatusCode : upstreamStatusCode // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
/// Create a copy of Sub2ApiUsageErrorDetail
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsageErrorDetail value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsageErrorDetail value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsageErrorDetail value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsageErrorDetail() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Sub2ApiUsageError summary,  String errorBody,  int? upstreamStatusCode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sub2ApiUsageErrorDetail() when $default != null:
return $default(_that.summary,_that.errorBody,_that.upstreamStatusCode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Sub2ApiUsageError summary,  String errorBody,  int? upstreamStatusCode)  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageErrorDetail():
return $default(_that.summary,_that.errorBody,_that.upstreamStatusCode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Sub2ApiUsageError summary,  String errorBody,  int? upstreamStatusCode)?  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageErrorDetail() when $default != null:
return $default(_that.summary,_that.errorBody,_that.upstreamStatusCode);case _:
  return null;
...
class _Sub2ApiUsageErrorDetail implements Sub2ApiUsageErrorDetail {
  const _Sub2ApiUsageErrorDetail({required this.summary, required this.errorBody, this.upstreamStatusCode});


@override final  Sub2ApiUsageError summary;
@override final  String errorBody;
@override final  int? upstreamStatusCode;

/// Create a copy of Sub2ApiUsageErrorDetail
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsageErrorDetailCopyWith<_Sub2ApiUsageErrorDetail> get copyWith => __$Sub2ApiUsageErrorDetailCopyWithImpl<_Sub2ApiUsageErrorDetail>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsageErrorDetail&&(identical(other.summary, summary) || other.summary == summary)&&(identical(other.errorBody, errorBody) || other.errorBody == errorBody)&&(identical(other.upstreamStatusCode, upstreamStatusCode) || other.upstreamStatusCode == upstreamStatusCode));
}
...
/// @nodoc
abstract mixin class _$Sub2ApiUsageErrorDetailCopyWith<$Res> implements $Sub2ApiUsageErrorDetailCopyWith<$Res> {
  factory _$Sub2ApiUsageErrorDetailCopyWith(_Sub2ApiUsageErrorDetail value, $Res Function(_Sub2ApiUsageErrorDetail) _then) = __$Sub2ApiUsageErrorDetailCopyWithImpl;
@override @useResult
$Res call({
 Sub2ApiUsageError summary, String errorBody, int? upstreamStatusCode
});
...
@override $Sub2ApiUsageErrorCopyWith<$Res> get summary;
...
/// Create a copy of Sub2ApiUsageErrorDetail
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? summary = null,Object? errorBody = null,Object? upstreamStatusCode = freezed,}) {
  return _then(_Sub2ApiUsageErrorDetail(
summary: null == summary ? _self.summary : summary // ignore: cast_nullable_to_non_nullable
as Sub2ApiUsageError,errorBody: null == errorBody ? _self.errorBody : errorBody // ignore: cast_nullable_to_non_nullable
as String,upstreamStatusCode: freezed == upstreamStatusCode ? _self.upstreamStatusCode : upstreamStatusCode // ignore: cast_nullable_to_non_nullable
as int?,
...
mixin _$Sub2ApiUsagePlatformStats {
 ...
 String get platform; int get totalRequests; int get totalTokens; Sub2ApiDecimal get totalActualCost; int get todayRequests; int get todayTokens; Sub2ApiDecimal get todayActualCost;
/// Create a copy of Sub2ApiUsagePlatformStats
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Sub2ApiUsagePlatformStatsCopyWith<Sub2ApiUsagePlatformStats> get copyWith => _$Sub2ApiUsagePlatformStatsCopyWithImpl<Sub2ApiUsagePlatformStats>(this as Sub2ApiUsagePlatformStats, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sub2ApiUsagePlatformStats&&(identical(other.platform, platform) || other.platform == platform)&&(identical(other.totalRequests, totalRequests) || other.totalRequests == totalRequests)&&(identical(other.totalTokens, totalTokens) || other.totalTokens == totalTokens)&&(identical(other.totalActualCost, totalActualCost) || other.totalActualCost == totalActualCost)&&(identical(other.todayRequests, todayRequests) || other.todayRequests == todayRequests)&&(identical(other.todayTokens, todayTokens) || other.todayTokens == todayTokens)&&(identical(other.todayActualCost, todayActualCost) || other.todayActualCost == todayActualCost));
}


@override
int get hashCode => Object.hash(runtimeType,platform,totalRequests,totalTokens,totalActualCost,todayRequests,todayTokens,todayActualCost);
...
abstract mixin class $Sub2ApiUsagePlatformStatsCopyWith<$Res>  {
  factory $Sub2ApiUsagePlatformStatsCopyWith(Sub2ApiUsagePlatformStats value, $Res Function(Sub2ApiUsagePlatformStats) _then) = _$Sub2ApiUsagePlatformStatsCopyWithImpl;
@useResult
$Res call({
 String platform, int totalRequests, int totalTokens, Sub2ApiDecimal totalActualCost, int todayRequests, int todayTokens, Sub2ApiDecimal todayActualCost
});
...
/// Create a copy of Sub2ApiUsagePlatformStats
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? platform = null,Object? totalRequests = null,Object? totalTokens = null,Object? totalActualCost = null,Object? todayRequests = null,Object? todayTokens = null,Object? todayActualCost = null,}) {
  return _then(_self.copyWith(
...
as int,totalTokens: null == totalTokens ? _self.totalTokens : totalTokens // ignore: cast_nullable_to_non_nullable
as int,totalActualCost: null == totalActualCost ? _self.totalActualCost : totalActualCost // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsagePlatformStats value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsagePlatformStats value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsagePlatformStats value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsagePlatformStats() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String platform,  int totalRequests,  int totalTokens,  Sub2ApiDecimal totalActualCost,  int todayRequests,  int todayTokens,  Sub2ApiDecimal todayActualCost)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sub2ApiUsagePlatformStats() when $default != null:
return $default(_that.platform,_that.totalRequests,_that.totalTokens,_that.totalActualCost,_that.todayRequests,_that.todayTokens,_that.todayActualCost);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String platform,  int totalRequests,  int totalTokens,  Sub2ApiDecimal totalActualCost,  int todayRequests,  int todayTokens,  Sub2ApiDecimal todayActualCost)  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsagePlatformStats():
return $default(_that.platform,_that.totalRequests,_that.totalTokens,_that.totalActualCost,_that.todayRequests,_that.todayTokens,_that.todayActualCost);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String platform,  int totalRequests,  int totalTokens,  Sub2ApiDecimal totalActualCost,  int todayRequests,  int todayTokens,  Sub2ApiDecimal todayActualCost)?  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsagePlatformStats() when $default != null:
return $default(_that.platform,_that.totalRequests,_that.totalTokens,_that.totalActualCost,_that.todayRequests,_that.todayTokens,_that.todayActualCost);case _:
  return null;
...
class _Sub2ApiUsagePlatformStats implements Sub2ApiUsagePlatformStats {
  const _Sub2ApiUsagePlatformStats({required this.platform, required this.totalRequests, required this.totalTokens, required this.totalActualCost, required this.todayRequests, required this.todayTokens, required this.todayActualCost});
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsagePlatformStatsCopyWith<_Sub2ApiUsagePlatformStats> get copyWith => __$Sub2ApiUsagePlatformStatsCopyWithImpl<_Sub2ApiUsagePlatformStats>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsagePlatformStats&&(identical(other.platform, platform) || other.platform == platform)&&(identical(other.totalRequests, totalRequests) || other.totalRequests == totalRequests)&&(identical(other.totalTokens, totalTokens) || other.totalTokens == totalTokens)&&(identical(other.totalActualCost, totalActualCost) || other.totalActualCost == totalActualCost)&&(identical(other.todayRequests, todayRequests) || other.todayRequests == todayRequests)&&(identical(other.todayTokens, todayTokens) || other.todayTokens == todayTokens)&&(identical(other.todayActualCost, todayActualCost) || other.todayActualCost == todayActualCost));
}
...
/// @nodoc
abstract mixin class _$Sub2ApiUsagePlatformStatsCopyWith<$Res> implements $Sub2ApiUsagePlatformStatsCopyWith<$Res> {
  factory _$Sub2ApiUsagePlatformStatsCopyWith(_Sub2ApiUsagePlatformStats value, $Res Function(_Sub2ApiUsagePlatformStats) _then) = __$Sub2ApiUsagePlatformStatsCopyWithImpl;
@override @useResult
$Res call({
 String platform, int totalRequests, int totalTokens, Sub2ApiDecimal totalActualCost, int todayRequests, int todayTokens, Sub2ApiDecimal todayActualCost
});
...
/// Create a copy of Sub2ApiUsagePlatformStats
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? platform = null,Object? totalRequests = null,Object? totalTokens = null,Object? totalActualCost = null,Object? todayRequests = null,Object? todayTokens = null,Object? todayActualCost = null,}) {
  return _then(_Sub2ApiUsagePlatformStats(
platform: null == platform ? _self.platform : platform // ignore: cast_nullable_to_non_nullable
as String,totalRequests: null == totalRequests ? _self.totalRequests : totalRequests // ignore: cast_nullable_to_non_nullable
as int,totalTokens: null == totalTokens ? _self.totalTokens : totalTokens // ignore: cast_nullable_to_non_nullable
as int,totalActualCost: null == totalActualCost ? _self.totalActualCost : totalActualCost // ignore: cast_nullable_to_non_nullable
...
abstract mixin class $Sub2ApiUsageDashboardStatsCopyWith<$Res>  {
  factory $Sub2ApiUsageDashboardStatsCopyWith(Sub2ApiUsageDashboardStats value, $Res Function(Sub2ApiUsageDashboardStats) _then) = _$Sub2ApiUsageDashboardStatsCopyWithImpl;
@useResult
$Res call({
 int totalApiKeys, int activeApiKeys, int totalRequests, int totalInputTokens, int totalOutputTokens, int totalCacheCreationTokens, int totalCacheReadTokens, int totalTokens, Sub2ApiDecimal totalCost, Sub2ApiDecimal totalActualCost, int todayRequests, int todayInputTokens, int todayOutputTokens, int todayCacheCreationTokens, int todayCacheReadTokens, int todayTokens, Sub2ApiDecimal todayCost, Sub2ApiDecimal todayActualCost, Sub2ApiDecimal averageDurationMs, int rpm, int tpm, List<Sub2ApiUsagePlatformStats> byPlatform
});
...
/// Create a copy of Sub2ApiUsageDashboardStats
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? totalApiKeys = null,Object? activeApiKeys = null,Object? totalRequests = null,Object? totalInputTokens = null,Object? totalOutputTokens = null,Object? totalCacheCreationTokens = null,Object? totalCacheReadTokens = null,Object? totalTokens = null,Object? totalCost = null,Object? totalActualCost = null,Object? todayRequests = null,Object? todayInputTokens = null,Object? todayOutputTokens = null,Object? todayCacheCreationTokens = null,Object? todayCacheReadTokens = null,Object? todayTokens = null,Object? todayCost = null,Object? todayActualCost = null,Object? averageDurationMs = null,Object? rpm = null,Object? tpm = null,Object? byPlatform = null,}) {
  return _then(_self.copyWith(
totalApiKeys: null == totalApiKeys ? _self.totalApiKeys : totalApiKeys // ignore: cast_nullable_to_non_nullable
...
as int,byPlatform: null == byPlatform ? _self.byPlatform : byPlatform // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsageDashboardStats value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsageDashboardStats value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsageDashboardStats value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardStats() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int totalApiKeys,  int activeApiKeys,  int totalRequests,  int totalInputTokens,  int totalOutputTokens,  int totalCacheCreationTokens,  int totalCacheReadTokens,  int totalTokens,  Sub2ApiDecimal totalCost,  Sub2ApiDecimal totalActualCost,  int todayRequests,  int todayInputTokens,  int todayOutputTokens,  int todayCacheCreationTokens,  int todayCacheReadTokens,  int todayTokens,  Sub2ApiDecimal todayCost,  Sub2ApiDecimal todayActualCost,  Sub2ApiDecimal averageDurationMs,  int rpm,  int tpm,  List<Sub2ApiUsagePlatformStats> byPlatform)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardStats() when $default != null:
return $default(_that.totalApiKeys,_that.activeApiKeys,_that.totalRequests,_that.totalInputTokens,_that.totalOutputTokens,_that.totalCacheCreationTokens,_that.totalCacheReadTokens,_that.totalTokens,_that.totalCost,_that.totalActualCost,_that.todayRequests,_that.todayInputTokens,_that.todayOutputTokens,_that.todayCacheCreationTokens,_that.todayCacheReadTokens,_that.todayTokens,_that.todayCost,_that.todayActualCost,_that.averageDurationMs,_that.rpm,_that.tpm,_that.byPlatform);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int totalApiKeys,  int activeApiKeys,  int totalRequests,  int totalInputTokens,  int totalOutputTokens,  int totalCacheCreationTokens,  int totalCacheReadTokens,  int totalTokens,  Sub2ApiDecimal totalCost,  Sub2ApiDecimal totalActualCost,  int todayRequests,  int todayInputTokens,  int todayOutputTokens,  int todayCacheCreationTokens,  int todayCacheReadTokens,  int todayTokens,  Sub2ApiDecimal todayCost,  Sub2ApiDecimal todayActualCost,  Sub2ApiDecimal averageDurationMs,  int rpm,  int tpm,  List<Sub2ApiUsagePlatformStats> byPlatform)  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardStats():
return $default(_that.totalApiKeys,_that.activeApiKeys,_that.totalRequests,_that.totalInputTokens,_that.totalOutputTokens,_that.totalCacheCreationTokens,_that.totalCacheReadTokens,_that.totalTokens,_that.totalCost,_that.totalActualCost,_that.todayRequests,_that.todayInputTokens,_that.todayOutputTokens,_that.todayCacheCreationTokens,_that.todayCacheReadTokens,_that.todayTokens,_that.todayCost,_that.todayActualCost,_that.averageDurationMs,_that.rpm,_that.tpm,_that.byPlatform);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int totalApiKeys,  int activeApiKeys,  int totalRequests,  int totalInputTokens,  int totalOutputTokens,  int totalCacheCreationTokens,  int totalCacheReadTokens,  int totalTokens,  Sub2ApiDecimal totalCost,  Sub2ApiDecimal totalActualCost,  int todayRequests,  int todayInputTokens,  int todayOutputTokens,  int todayCacheCreationTokens,  int todayCacheReadTokens,  int todayTokens,  Sub2ApiDecimal todayCost,  Sub2ApiDecimal todayActualCost,  Sub2ApiDecimal averageDurationMs,  int rpm,  int tpm,  List<Sub2ApiUsagePlatformStats> byPlatform)?  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardStats() when $default != null:
return $default(_that.totalApiKeys,_that.activeApiKeys,_that.totalRequests,_that.totalInputTokens,_that.totalOutputTokens,_that.totalCacheCreationTokens,_that.totalCacheReadTokens,_that.totalTokens,_that.totalCost,_that.totalActualCost,_that.todayRequests,_that.todayInputTokens,_that.todayOutputTokens,_that.todayCacheCreationTokens,_that.todayCacheReadTokens,_that.todayTokens,_that.todayCost,_that.todayActualCost,_that.averageDurationMs,_that.rpm,_that.tpm,_that.byPlatform);case _:
  return null;
...
@override List<Sub2ApiUsagePlatformStats> get byPlatform {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsageDashboardStatsCopyWith<_Sub2ApiUsageDashboardStats> get copyWith => __$Sub2ApiUsageDashboardStatsCopyWithImpl<_Sub2ApiUsageDashboardStats>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsageDashboardStats&&(identical(other.totalApiKeys, totalApiKeys) || other.totalApiKeys == totalApiKeys)&&(identical(other.activeApiKeys, activeApiKeys) || other.activeApiKeys == activeApiKeys)&&(identical(other.totalRequests, totalRequests) || other.totalRequests == totalRequests)&&(identical(other.totalInputTokens, totalInputTokens) || other.totalInputTokens == totalInputTokens)&&(identical(other.totalOutputTokens, totalOutputTokens) || other.totalOutputTokens == totalOutputTokens)&&(identical(other.totalCacheCreationTokens, totalCacheCreationTokens) || other.totalCacheCreationTokens == totalCacheCreationTokens)&&(identical(other.totalCacheReadTokens, totalCacheReadTokens) || other.totalCacheReadTokens == totalCacheReadTokens)&&(identical(other.totalTokens, totalTokens) || other.totalTokens == totalTokens)&&(identical(other.totalCost, totalCost) || other.totalCost == totalCost)&&(identical(other.totalActualCost, totalActualCost) || other.totalActualCost == totalActualCost)&&(identical(other.todayRequests, todayRequests) || other.todayRequests == todayRequests)&&(identical(other.todayInputTokens, todayInputTokens) || other.todayInputTokens == todayInputTokens)&&(identical(other.todayOutputTokens, todayOutputTokens) || other.todayOutputTokens == todayOutputTokens)&&(identical(other.todayCacheCreationTokens, todayCacheCreationTokens) || other.todayCacheCreationTokens == todayCacheCreationTokens)&&(identical(other.todayCacheReadTokens, todayCacheReadTokens) || other.todayCacheReadTokens == todayCacheReadTokens)&&(identical(other.todayTokens, todayTokens) || other.todayTokens == todayTokens)&&(identical(other.todayCost, todayCost) || other.todayCost == todayCost)&&(identical(other.todayActualCost, todayActualCost) || other.todayActualCost == todayActualCost)&&(identical(other.averageDurationMs, averageDurationMs) || other.averageDurationMs == averageDurationMs)&&(identical(other.rpm, rpm) || other.rpm == rpm)&&(identical(other.tpm, tpm) || other.tpm == tpm)&&const DeepCollectionEquality().equals(other._byPlatform, _byPlatform));
}


@override
int get hashCode => Object.hashAll([runtimeType,totalApiKeys,activeApiKeys,totalRequests,totalInputTokens,totalOutputTokens,totalCacheCreationTokens,totalCacheReadTokens,totalTokens,totalCost,totalActualCost,todayRequests,todayInputTokens,todayOutputTokens,todayCacheCreationTokens,todayCacheReadTokens,todayTokens,todayCost,todayActualCost,averageDurationMs,rpm,tpm,const DeepCollectionEquality().hash(_byPlatform)]);
...
/// @nodoc
abstract mixin class _$Sub2ApiUsageDashboardStatsCopyWith<$Res> implements $Sub2ApiUsageDashboardStatsCopyWith<$Res> {
  factory _$Sub2ApiUsageDashboardStatsCopyWith(_Sub2ApiUsageDashboardStats value, $Res Function(_Sub2ApiUsageDashboardStats) _then) = __$Sub2ApiUsageDashboardStatsCopyWithImpl;
@override @useResult
$Res call({
 int totalApiKeys, int activeApiKeys, int totalRequests, int totalInputTokens, int totalOutputTokens, int totalCacheCreationTokens, int totalCacheReadTokens, int totalTokens, Sub2ApiDecimal totalCost, Sub2ApiDecimal totalActualCost, int todayRequests, int todayInputTokens, int todayOutputTokens, int todayCacheCreationTokens, int todayCacheReadTokens, int todayTokens, Sub2ApiDecimal todayCost, Sub2ApiDecimal todayActualCost, Sub2ApiDecimal averageDurationMs, int rpm, int tpm, List<Sub2ApiUsagePlatformStats> byPlatform
});
...
/// Create a copy of Sub2ApiUsageDashboardStats
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? totalApiKeys = null,Object? activeApiKeys = null,Object? totalRequests = null,Object? totalInputTokens = null,Object? totalOutputTokens = null,Object? totalCacheCreationTokens = null,Object? totalCacheReadTokens = null,Object? totalTokens = null,Object? totalCost = null,Object? totalActualCost = null,Object? todayRequests = null,Object? todayInputTokens = null,Object? todayOutputTokens = null,Object? todayCacheCreationTokens = null,Object? todayCacheReadTokens = null,Object? todayTokens = null,Object? todayCost = null,Object? todayActualCost = null,Object? averageDurationMs = null,Object? rpm = null,Object? tpm = null,Object? byPlatform = null,}) {
  return _then(_Sub2ApiUsageDashboardStats(
totalApiKeys: null == totalApiKeys ? _self.totalApiKeys : totalApiKeys // ignore: cast_nullable_to_non_nullable
as int,activeApiKeys: null == activeApiKeys ? _self.activeApiKeys : activeApiKeys // ignore: cast_nullable_to_non_nullable
as int,totalRequests: null == totalRequests ? _self.totalRequests : totalRequests // ignore: cast_nullable_to_non_nullable
as int,totalInputTokens: null == totalInputTokens ? _self.totalInputTokens : totalInputTokens // ignore: cast_nullable_to_non_nullable
...
as Sub2ApiDecimal,rpm: null == rpm ? _self.rpm : rpm // ignore: cast_nullable_to_non_nullable
as int,tpm: null == tpm ? _self.tpm : tpm // ignore: cast_nullable_to_non_nullable
as int,byPlatform: null == byPlatform ? _self._byPlatform : byPlatform // ignore: cast_nullable_to_non_nullable
as List<Sub2ApiUsagePlatformStats>,
  ));
}
...
mixin _$Sub2ApiUsageDashboardQuery {
 ...
 DateTime? get startDate; DateTime? get endDate; String? get period; Sub2ApiUsageGranularity get granularity; int? get apiKeyId; int? get groupId; String? get model; String? get requestType; bool? get stream; int? get billingType; String? get billingMode; String? get timezone;
/// Create a copy of Sub2ApiUsageDashboardQuery
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Sub2ApiUsageDashboardQueryCopyWith<Sub2ApiUsageDashboardQuery> get copyWith => _$Sub2ApiUsageDashboardQueryCopyWithImpl<Sub2ApiUsageDashboardQuery>(this as Sub2ApiUsageDashboardQuery, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sub2ApiUsageDashboardQuery&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.period, period) || other.period == period)&&(identical(other.granularity, granularity) || other.granularity == granularity)&&(identical(other.apiKeyId, apiKeyId) || other.apiKeyId == apiKeyId)&&(identical(other.groupId, groupId) || other.groupId == groupId)&&(identical(other.model, model) || other.model == model)&&(identical(other.requestType, requestType) || other.requestType == requestType)&&(identical(other.stream, stream) || other.stream == stream)&&(identical(other.billingType, billingType) || other.billingType == billingType)&&(identical(other.billingMode, billingMode) || other.billingMode == billingMode)&&(identical(other.timezone, timezone) || other.timezone == timezone));
}


@override
int get hashCode => Object.hash(runtimeType,startDate,endDate,period,granularity,apiKeyId,groupId,model,requestType,stream,billingType,billingMode,timezone);
...
abstract mixin class $Sub2ApiUsageDashboardQueryCopyWith<$Res>  {
  factory $Sub2ApiUsageDashboardQueryCopyWith(Sub2ApiUsageDashboardQuery value, $Res Function(Sub2ApiUsageDashboardQuery) _then) = _$Sub2ApiUsageDashboardQueryCopyWithImpl;
@useResult
$Res call({
 DateTime? startDate, DateTime? endDate, String? period, Sub2ApiUsageGranularity granularity, int? apiKeyId, int? groupId, String? model, String? requestType, bool? stream, int? billingType, String? billingMode, String? timezone
});
...
/// Create a copy of Sub2ApiUsageDashboardQuery
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? startDate = freezed,Object? endDate = freezed,Object? period = freezed,Object? granularity = null,Object? apiKeyId = freezed,Object? groupId = freezed,Object? model = freezed,Object? requestType = freezed,Object? stream = freezed,Object? billingType = freezed,Object? billingMode = freezed,Object? timezone = freezed,}) {
  return _then(_self.copyWith(
...
as Sub2ApiUsageGranularity,apiKeyId: freezed == apiKeyId ? _self.apiKeyId : apiKeyId // ignore: cast_nullable_to_non_nullable
as int?,groupId: freezed == groupId ? _self.groupId : groupId // ignore: cast_nullable_to_non_nullable
as int?,model: freezed == model ? _self.model : model // ignore: cast_nullable_to_non_nullable
as String?,requestType: freezed == requestType ? _self.requestType : requestType // ignore: cast_nullable_to_non_nullable
as String?,stream: freezed == stream ? _self.stream : stream // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsageDashboardQuery value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsageDashboardQuery value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsageDashboardQuery value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardQuery() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime? startDate,  DateTime? endDate,  String? period,  Sub2ApiUsageGranularity granularity,  int? apiKeyId,  int? groupId,  String? model,  String? requestType,  bool? stream,  int? billingType,  String? billingMode,  String? timezone)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardQuery() when $default != null:
return $default(_that.startDate,_that.endDate,_that.period,_that.granularity,_that.apiKeyId,_that.groupId,_that.model,_that.requestType,_that.stream,_that.billingType,_that.billingMode,_that.timezone);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime? startDate,  DateTime? endDate,  String? period,  Sub2ApiUsageGranularity granularity,  int? apiKeyId,  int? groupId,  String? model,  String? requestType,  bool? stream,  int? billingType,  String? billingMode,  String? timezone)  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardQuery():
return $default(_that.startDate,_that.endDate,_that.period,_that.granularity,_that.apiKeyId,_that.groupId,_that.model,_that.requestType,_that.stream,_that.billingType,_that.billingMode,_that.timezone);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime? startDate,  DateTime? endDate,  String? period,  Sub2ApiUsageGranularity granularity,  int? apiKeyId,  int? groupId,  String? model,  String? requestType,  bool? stream,  int? billingType,  String? billingMode,  String? timezone)?  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardQuery() when $default != null:
return $default(_that.startDate,_that.endDate,_that.period,_that.granularity,_that.apiKeyId,_that.groupId,_that.model,_that.requestType,_that.stream,_that.billingType,_that.billingMode,_that.timezone);case _:
  return null;
...
class _Sub2ApiUsageDashboardQuery implements Sub2ApiUsageDashboardQuery {
  const _Sub2ApiUsageDashboardQuery({this.startDate, this.endDate, this.period, this.granularity = Sub2ApiUsageGranularity.day, this.apiKeyId, this.groupId, this.model, this.requestType, this.stream, this.billingType, this.billingMode, this.timezone});


@override final  DateTime? startDate;
@override final  DateTime? endDate;
@override final  String? period;
@override@JsonKey() final  Sub2ApiUsageGranularity granularity;
@override final  int? apiKeyId;
@override final  int? groupId;
@override final  String? model;
@override final  String? requestType;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsageDashboardQueryCopyWith<_Sub2ApiUsageDashboardQuery> get copyWith => __$Sub2ApiUsageDashboardQueryCopyWithImpl<_Sub2ApiUsageDashboardQuery>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsageDashboardQuery&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.period, period) || other.period == period)&&(identical(other.granularity, granularity) || other.granularity == granularity)&&(identical(other.apiKeyId, apiKeyId) || other.apiKeyId == apiKeyId)&&(identical(other.groupId, groupId) || other.groupId == groupId)&&(identical(other.model, model) || other.model == model)&&(identical(other.requestType, requestType) || other.requestType == requestType)&&(identical(other.stream, stream) || other.stream == stream)&&(identical(other.billingType, billingType) || other.billingType == billingType)&&(identical(other.billingMode, billingMode) || other.billingMode == billingMode)&&(identical(other.timezone, timezone) || other.timezone == timezone));
}
...
/// @nodoc
abstract mixin class _$Sub2ApiUsageDashboardQueryCopyWith<$Res> implements $Sub2ApiUsageDashboardQueryCopyWith<$Res> {
  factory _$Sub2ApiUsageDashboardQueryCopyWith(_Sub2ApiUsageDashboardQuery value, $Res Function(_Sub2ApiUsageDashboardQuery) _then) = __$Sub2ApiUsageDashboardQueryCopyWithImpl;
@override @useResult
$Res call({
 DateTime? startDate, DateTime? endDate, String? period, Sub2ApiUsageGranularity granularity, int? apiKeyId, int? groupId, String? model, String? requestType, bool? stream, int? billingType, String? billingMode, String? timezone
});
...
/// Create a copy of Sub2ApiUsageDashboardQuery
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? startDate = freezed,Object? endDate = freezed,Object? period = freezed,Object? granularity = null,Object? apiKeyId = freezed,Object? groupId = freezed,Object? model = freezed,Object? requestType = freezed,Object? stream = freezed,Object? billingType = freezed,Object? billingMode = freezed,Object? timezone = freezed,}) {
  return _then(_Sub2ApiUsageDashboardQuery(
startDate: freezed == startDate ? _self.startDate : startDate // ignore: cast_nullable_to_non_nullable
as DateTime?,endDate: freezed == endDate ? _self.endDate : endDate // ignore: cast_nullable_to_non_nullable
as DateTime?,period: freezed == period ? _self.period : period // ignore: cast_nullable_to_non_nullable
as String?,granularity: null == granularity ? _self.granularity : granularity // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Sub2ApiUsageTrendPointCopyWith<Sub2ApiUsageTrendPoint> get copyWith => _$Sub2ApiUsageTrendPointCopyWithImpl<Sub2ApiUsageTrendPoint>(this as Sub2ApiUsageTrendPoint, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sub2ApiUsageTrendPoint&&(identical(other.date, date) || other.date == date)&&(identical(other.requests, requests) || other.requests == requests)&&(identical(other.inputTokens, inputTokens) || other.inputTokens == inputTokens)&&(identical(other.outputTokens, outputTokens) || other.outputTokens == outputTokens)&&(identical(other.cacheCreationTokens, cacheCreationTokens) || other.cacheCreationTokens == cacheCreationTokens)&&(identical(other.cacheReadTokens, cacheReadTokens) || other.cacheReadTokens == cacheReadTokens)&&(identical(other.totalTokens, totalTokens) || other.totalTokens == totalTokens)&&(identical(other.cost, cost) || other.cost == cost)&&(identical(other.actualCost, actualCost) || other.actualCost == actualCost));
}
...
abstract mixin class $Sub2ApiUsageTrendPointCopyWith<$Res>  {
  factory $Sub2ApiUsageTrendPointCopyWith(Sub2ApiUsageTrendPoint value, $Res Function(Sub2ApiUsageTrendPoint) _then) = _$Sub2ApiUsageTrendPointCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsageTrendPoint value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsageTrendPoint value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsageTrendPoint value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsageTrendPoint() when $default != null:
return $default(_that);case _:
...
class _Sub2ApiUsageTrendPoint implements Sub2ApiUsageTrendPoint {
  const _Sub2ApiUsageTrendPoint({required this.date, required this.requests, required this.inputTokens, required this.outputTokens, required this.cacheCreationTokens, required this.cacheReadTokens, required this.totalTokens, required this.cost, required this.actualCost});
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsageTrendPointCopyWith<_Sub2ApiUsageTrendPoint> get copyWith => __$Sub2ApiUsageTrendPointCopyWithImpl<_Sub2ApiUsageTrendPoint>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsageTrendPoint&&(identical(other.date, date) || other.date == date)&&(identical(other.requests, requests) || other.requests == requests)&&(identical(other.inputTokens, inputTokens) || other.inputTokens == inputTokens)&&(identical(other.outputTokens, outputTokens) || other.outputTokens == outputTokens)&&(identical(other.cacheCreationTokens, cacheCreationTokens) || other.cacheCreationTokens == cacheCreationTokens)&&(identical(other.cacheReadTokens, cacheReadTokens) || other.cacheReadTokens == cacheReadTokens)&&(identical(other.totalTokens, totalTokens) || other.totalTokens == totalTokens)&&(identical(other.cost, cost) || other.cost == cost)&&(identical(other.actualCost, actualCost) || other.actualCost == actualCost));
}
...
/// @nodoc
abstract mixin class _$Sub2ApiUsageTrendPointCopyWith<$Res> implements $Sub2ApiUsageTrendPointCopyWith<$Res> {
  factory _$Sub2ApiUsageTrendPointCopyWith(_Sub2ApiUsageTrendPoint value, $Res Function(_Sub2ApiUsageTrendPoint) _then) = __$Sub2ApiUsageTrendPointCopyWithImpl;
@override @useResult
$Res call({
 String date, int requests, int inputTokens, int outputTokens, int cacheCreationTokens, int cacheReadTokens, int totalTokens, Sub2ApiDecimal cost, Sub2ApiDecimal actualCost
});
...
@override @pragma('vm:prefer-inline') $Res call({Object? date = null,Object? requests = null,Object? inputTokens = null,Object? outputTokens = null,Object? cacheCreationTokens = null,Object? cacheReadTokens = null,Object? totalTokens = null,Object? cost = null,Object? actualCost = null,}) {
  return _then(_Sub2ApiUsageTrendPoint(
date: null == date ? _self.date : date // ignore: cast_nullable_to_non_nullable
as String,requests: null == requests ? _self.requests : requests // ignore: cast_nullable_to_non_nullable
as int,inputTokens: null == inputTokens ? _self.inputTokens : inputTokens // ignore: cast_nullable_to_non_nullable
as int,outputTokens: null == outputTokens ? _self.outputTokens : outputTokens // ignore: cast_nullable_to_non_nullable
...
mixin _$Sub2ApiUsageTrend {
 ...
 List<Sub2ApiUsageTrendPoint> get points; DateTime get startDate; DateTime get endDate; Sub2ApiUsageGranularity get granularity;
/// Create a copy of Sub2ApiUsageTrend
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Sub2ApiUsageTrendCopyWith<Sub2ApiUsageTrend> get copyWith => _$Sub2ApiUsageTrendCopyWithImpl<Sub2ApiUsageTrend>(this as Sub2ApiUsageTrend, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sub2ApiUsageTrend&&const DeepCollectionEquality().equals(other.points, points)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.granularity, granularity) || other.granularity == granularity));
}
...
abstract mixin class $Sub2ApiUsageTrendCopyWith<$Res>  {
  factory $Sub2ApiUsageTrendCopyWith(Sub2ApiUsageTrend value, $Res Function(Sub2ApiUsageTrend) _then) = _$Sub2ApiUsageTrendCopyWithImpl;
@useResult
$Res call({
 List<Sub2ApiUsageTrendPoint> points, DateTime startDate, DateTime endDate, Sub2ApiUsageGranularity granularity
});
...
as List<Sub2ApiUsageTrendPoint>,startDate: null == startDate ? _self.startDate : startDate // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsageTrend value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsageTrend value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsageTrend value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsageTrend() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Sub2ApiUsageTrendPoint> points,  DateTime startDate,  DateTime endDate,  Sub2ApiUsageGranularity granularity)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sub2ApiUsageTrend() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Sub2ApiUsageTrendPoint> points,  DateTime startDate,  DateTime endDate,  Sub2ApiUsageGranularity granularity)  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageTrend():
return $default(_that.points,_that.startDate,_that.endDate,_that.granularity);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Sub2ApiUsageTrendPoint> points,  DateTime startDate,  DateTime endDate,  Sub2ApiUsageGranularity granularity)?  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageTrend() when $default != null:
return $default(_that.points,_that.startDate,_that.endDate,_that.granularity);case _:
  return null;
...
class _Sub2ApiUsageTrend implements Sub2ApiUsageTrend {
  const _Sub2ApiUsageTrend({required final  List<Sub2ApiUsageTrendPoint> points, required this.startDate, required this.endDate, required this.granularity}): _points = points;


 final  List<Sub2ApiUsageTrendPoint> _points;
@override List<Sub2ApiUsageTrendPoint> get points {
...
@override final  DateTime startDate;
@override final  DateTime endDate;
@override final  Sub2ApiUsageGranularity granularity;

/// Create a copy of Sub2ApiUsageTrend
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsageTrendCopyWith<_Sub2ApiUsageTrend> get copyWith => __$Sub2ApiUsageTrendCopyWithImpl<_Sub2ApiUsageTrend>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsageTrend&&const DeepCollectionEquality().equals(other._points, _points)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.granularity, granularity) || other.granularity == granularity));
}
...
/// @nodoc
abstract mixin class _$Sub2ApiUsageTrendCopyWith<$Res> implements $Sub2ApiUsageTrendCopyWith<$Res> {
  factory _$Sub2ApiUsageTrendCopyWith(_Sub2ApiUsageTrend value, $Res Function(_Sub2ApiUsageTrend) _then) = __$Sub2ApiUsageTrendCopyWithImpl;
@override @useResult
$Res call({
 List<Sub2ApiUsageTrendPoint> points, DateTime startDate, DateTime endDate, Sub2ApiUsageGranularity granularity
});
...
@override @pragma('vm:prefer-inline') $Res call({Object? points = null,Object? startDate = null,Object? endDate = null,Object? granularity = null,}) {
  return _then(_Sub2ApiUsageTrend(
...
mixin _$Sub2ApiUsageModelStats {
 ...
 String get model; int get requests; int get inputTokens; int get outputTokens; int get cacheCreationTokens; int get cacheReadTokens; int get totalTokens; Sub2ApiDecimal get cost; Sub2ApiDecimal get actualCost;
/// Create a copy of Sub2ApiUsageModelStats
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Sub2ApiUsageModelStatsCopyWith<Sub2ApiUsageModelStats> get copyWith => _$Sub2ApiUsageModelStatsCopyWithImpl<Sub2ApiUsageModelStats>(this as Sub2ApiUsageModelStats, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sub2ApiUsageModelStats&&(identical(other.model, model) || other.model == model)&&(identical(other.requests, requests) || other.requests == requests)&&(identical(other.inputTokens, inputTokens) || other.inputTokens == inputTokens)&&(identical(other.outputTokens, outputTokens) || other.outputTokens == outputTokens)&&(identical(other.cacheCreationTokens, cacheCreationTokens) || other.cacheCreationTokens == cacheCreationTokens)&&(identical(other.cacheReadTokens, cacheReadTokens) || other.cacheReadTokens == cacheReadTokens)&&(identical(other.totalTokens, totalTokens) || other.totalTokens == totalTokens)&&(identical(other.cost, cost) || other.cost == cost)&&(identical(other.actualCost, actualCost) || other.actualCost == actualCost));
}


@override
int get hashCode => Object.hash(runtimeType,model,requests,inputTokens,outputTokens,cacheCreationTokens,cacheReadTokens,totalTokens,cost,actualCost);
...
abstract mixin class $Sub2ApiUsageModelStatsCopyWith<$Res>  {
  factory $Sub2ApiUsageModelStatsCopyWith(Sub2ApiUsageModelStats value, $Res Function(Sub2ApiUsageModelStats) _then) = _$Sub2ApiUsageModelStatsCopyWithImpl;
@useResult
$Res call({
 String model, int requests, int inputTokens, int outputTokens, int cacheCreationTokens, int cacheReadTokens, int totalTokens, Sub2ApiDecimal cost, Sub2ApiDecimal actualCost
});
...
/// Create a copy of Sub2ApiUsageModelStats
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? model = null,Object? requests = null,Object? inputTokens = null,Object? outputTokens = null,Object? cacheCreationTokens = null,Object? cacheReadTokens = null,Object? totalTokens = null,Object? cost = null,Object? actualCost = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsageModelStats value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsageModelStats value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsageModelStats value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsageModelStats() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String model,  int requests,  int inputTokens,  int outputTokens,  int cacheCreationTokens,  int cacheReadTokens,  int totalTokens,  Sub2ApiDecimal cost,  Sub2ApiDecimal actualCost)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sub2ApiUsageModelStats() when $default != null:
return $default(_that.model,_that.requests,_that.inputTokens,_that.outputTokens,_that.cacheCreationTokens,_that.cacheReadTokens,_that.totalTokens,_that.cost,_that.actualCost);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String model,  int requests,  int inputTokens,  int outputTokens,  int cacheCreationTokens,  int cacheReadTokens,  int totalTokens,  Sub2ApiDecimal cost,  Sub2ApiDecimal actualCost)  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageModelStats():
return $default(_that.model,_that.requests,_that.inputTokens,_that.outputTokens,_that.cacheCreationTokens,_that.cacheReadTokens,_that.totalTokens,_that.cost,_that.actualCost);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String model,  int requests,  int inputTokens,  int outputTokens,  int cacheCreationTokens,  int cacheReadTokens,  int totalTokens,  Sub2ApiDecimal cost,  Sub2ApiDecimal actualCost)?  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageModelStats() when $default != null:
return $default(_that.model,_that.requests,_that.inputTokens,_that.outputTokens,_that.cacheCreationTokens,_that.cacheReadTokens,_that.totalTokens,_that.cost,_that.actualCost);case _:
  return null;
...
class _Sub2ApiUsageModelStats implements Sub2ApiUsageModelStats {
  const _Sub2ApiUsageModelStats({required this.model, required this.requests, required this.inputTokens, required this.outputTokens, required this.cacheCreationTokens, required this.cacheReadTokens, required this.totalTokens, required this.cost, required this.actualCost});
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsageModelStatsCopyWith<_Sub2ApiUsageModelStats> get copyWith => __$Sub2ApiUsageModelStatsCopyWithImpl<_Sub2ApiUsageModelStats>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsageModelStats&&(identical(other.model, model) || other.model == model)&&(identical(other.requests, requests) || other.requests == requests)&&(identical(other.inputTokens, inputTokens) || other.inputTokens == inputTokens)&&(identical(other.outputTokens, outputTokens) || other.outputTokens == outputTokens)&&(identical(other.cacheCreationTokens, cacheCreationTokens) || other.cacheCreationTokens == cacheCreationTokens)&&(identical(other.cacheReadTokens, cacheReadTokens) || other.cacheReadTokens == cacheReadTokens)&&(identical(other.totalTokens, totalTokens) || other.totalTokens == totalTokens)&&(identical(other.cost, cost) || other.cost == cost)&&(identical(other.actualCost, actualCost) || other.actualCost == actualCost));
}
...
/// @nodoc
abstract mixin class _$Sub2ApiUsageModelStatsCopyWith<$Res> implements $Sub2ApiUsageModelStatsCopyWith<$Res> {
  factory _$Sub2ApiUsageModelStatsCopyWith(_Sub2ApiUsageModelStats value, $Res Function(_Sub2ApiUsageModelStats) _then) = __$Sub2ApiUsageModelStatsCopyWithImpl;
@override @useResult
$Res call({
 String model, int requests, int inputTokens, int outputTokens, int cacheCreationTokens, int cacheReadTokens, int totalTokens, Sub2ApiDecimal cost, Sub2ApiDecimal actualCost
});
...
/// Create a copy of Sub2ApiUsageModelStats
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? model = null,Object? requests = null,Object? inputTokens = null,Object? outputTokens = null,Object? cacheCreationTokens = null,Object? cacheReadTokens = null,Object? totalTokens = null,Object? cost = null,Object? actualCost = null,}) {
  return _then(_Sub2ApiUsageModelStats(
model: null == model ? _self.model : model // ignore: cast_nullable_to_non_nullable
as String,requests: null == requests ? _self.requests : requests // ignore: cast_nullable_to_non_nullable
as int,inputTokens: null == inputTokens ? _self.inputTokens : inputTokens // ignore: cast_nullable_to_non_nullable
as int,outputTokens: null == outputTokens ? _self.outputTokens : outputTokens // ignore: cast_nullable_to_non_nullable
...
mixin _$Sub2ApiUsageModels {
 ...
 List<Sub2ApiUsageModelStats> get models; DateTime get startDate; DateTime get endDate;
/// Create a copy of Sub2ApiUsageModels
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Sub2ApiUsageModelsCopyWith<Sub2ApiUsageModels> get copyWith => _$Sub2ApiUsageModelsCopyWithImpl<Sub2ApiUsageModels>(this as Sub2ApiUsageModels, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sub2ApiUsageModels&&const DeepCollectionEquality().equals(other.models, models)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate));
}
...
abstract mixin class $Sub2ApiUsageModelsCopyWith<$Res>  {
  factory $Sub2ApiUsageModelsCopyWith(Sub2ApiUsageModels value, $Res Function(Sub2ApiUsageModels) _then) = _$Sub2ApiUsageModelsCopyWithImpl;
@useResult
$Res call({
 List<Sub2ApiUsageModelStats> models, DateTime startDate, DateTime endDate
});
...
as List<Sub2ApiUsageModelStats>,startDate: null == startDate ? _self.startDate : startDate // ignore: cast_nullable_to_non_nullable
as DateTime,endDate: null == endDate ? _self.endDate : endDate // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsageModels value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsageModels value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsageModels value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsageModels() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Sub2ApiUsageModelStats> models,  DateTime startDate,  DateTime endDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sub2ApiUsageModels() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Sub2ApiUsageModelStats> models,  DateTime startDate,  DateTime endDate)  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageModels():
return $default(_that.models,_that.startDate,_that.endDate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Sub2ApiUsageModelStats> models,  DateTime startDate,  DateTime endDate)?  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageModels() when $default != null:
return $default(_that.models,_that.startDate,_that.endDate);case _:
  return null;
...
class _Sub2ApiUsageModels implements Sub2ApiUsageModels {
  const _Sub2ApiUsageModels({required final  List<Sub2ApiUsageModelStats> models, required this.startDate, required this.endDate}): _models = models;


 final  List<Sub2ApiUsageModelStats> _models;
@override List<Sub2ApiUsageModelStats> get models {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsageModelsCopyWith<_Sub2ApiUsageModels> get copyWith => __$Sub2ApiUsageModelsCopyWithImpl<_Sub2ApiUsageModels>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsageModels&&const DeepCollectionEquality().equals(other._models, _models)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate));
}
...
/// @nodoc
abstract mixin class _$Sub2ApiUsageModelsCopyWith<$Res> implements $Sub2ApiUsageModelsCopyWith<$Res> {
  factory _$Sub2ApiUsageModelsCopyWith(_Sub2ApiUsageModels value, $Res Function(_Sub2ApiUsageModels) _then) = __$Sub2ApiUsageModelsCopyWithImpl;
@override @useResult
$Res call({
 List<Sub2ApiUsageModelStats> models, DateTime startDate, DateTime endDate
});
...
@override @pragma('vm:prefer-inline') $Res call({Object? models = null,Object? startDate = null,Object? endDate = null,}) {
  return _then(_Sub2ApiUsageModels(
...
mixin _$Sub2ApiUsageGroupStats {
 ...
 int get groupId; String get groupName; int get requests; int get totalTokens; Sub2ApiDecimal get cost; Sub2ApiDecimal get actualCost;
/// Create a copy of Sub2ApiUsageGroupStats
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Sub2ApiUsageGroupStatsCopyWith<Sub2ApiUsageGroupStats> get copyWith => _$Sub2ApiUsageGroupStatsCopyWithImpl<Sub2ApiUsageGroupStats>(this as Sub2ApiUsageGroupStats, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sub2ApiUsageGroupStats&&(identical(other.groupId, groupId) || other.groupId == groupId)&&(identical(other.groupName, groupName) || other.groupName == groupName)&&(identical(other.requests, requests) || other.requests == requests)&&(identical(other.totalTokens, totalTokens) || other.totalTokens == totalTokens)&&(identical(other.cost, cost) || other.cost == cost)&&(identical(other.actualCost, actualCost) || other.actualCost == actualCost));
}


@override
int get hashCode => Object.hash(runtimeType,groupId,groupName,requests,totalTokens,cost,actualCost);
...
abstract mixin class $Sub2ApiUsageGroupStatsCopyWith<$Res>  {
  factory $Sub2ApiUsageGroupStatsCopyWith(Sub2ApiUsageGroupStats value, $Res Function(Sub2ApiUsageGroupStats) _then) = _$Sub2ApiUsageGroupStatsCopyWithImpl;
@useResult
$Res call({
 int groupId, String groupName, int requests, int totalTokens, Sub2ApiDecimal cost, Sub2ApiDecimal actualCost
});
...
/// Create a copy of Sub2ApiUsageGroupStats
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? groupId = null,Object? groupName = null,Object? requests = null,Object? totalTokens = null,Object? cost = null,Object? actualCost = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsageGroupStats value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsageGroupStats value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsageGroupStats value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsageGroupStats() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int groupId,  String groupName,  int requests,  int totalTokens,  Sub2ApiDecimal cost,  Sub2ApiDecimal actualCost)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sub2ApiUsageGroupStats() when $default != null:
return $default(_that.groupId,_that.groupName,_that.requests,_that.totalTokens,_that.cost,_that.actualCost);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int groupId,  String groupName,  int requests,  int totalTokens,  Sub2ApiDecimal cost,  Sub2ApiDecimal actualCost)  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageGroupStats():
return $default(_that.groupId,_that.groupName,_that.requests,_that.totalTokens,_that.cost,_that.actualCost);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int groupId,  String groupName,  int requests,  int totalTokens,  Sub2ApiDecimal cost,  Sub2ApiDecimal actualCost)?  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageGroupStats() when $default != null:
return $default(_that.groupId,_that.groupName,_that.requests,_that.totalTokens,_that.cost,_that.actualCost);case _:
  return null;
...
class _Sub2ApiUsageGroupStats implements Sub2ApiUsageGroupStats {
  const _Sub2ApiUsageGroupStats({required this.groupId, required this.groupName, required this.requests, required this.totalTokens, required this.cost, required this.actualCost});
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsageGroupStatsCopyWith<_Sub2ApiUsageGroupStats> get copyWith => __$Sub2ApiUsageGroupStatsCopyWithImpl<_Sub2ApiUsageGroupStats>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsageGroupStats&&(identical(other.groupId, groupId) || other.groupId == groupId)&&(identical(other.groupName, groupName) || other.groupName == groupName)&&(identical(other.requests, requests) || other.requests == requests)&&(identical(other.totalTokens, totalTokens) || other.totalTokens == totalTokens)&&(identical(other.cost, cost) || other.cost == cost)&&(identical(other.actualCost, actualCost) || other.actualCost == actualCost));
}
...
/// @nodoc
abstract mixin class _$Sub2ApiUsageGroupStatsCopyWith<$Res> implements $Sub2ApiUsageGroupStatsCopyWith<$Res> {
  factory _$Sub2ApiUsageGroupStatsCopyWith(_Sub2ApiUsageGroupStats value, $Res Function(_Sub2ApiUsageGroupStats) _then) = __$Sub2ApiUsageGroupStatsCopyWithImpl;
@override @useResult
$Res call({
 int groupId, String groupName, int requests, int totalTokens, Sub2ApiDecimal cost, Sub2ApiDecimal actualCost
});
...
/// Create a copy of Sub2ApiUsageGroupStats
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? groupId = null,Object? groupName = null,Object? requests = null,Object? totalTokens = null,Object? cost = null,Object? actualCost = null,}) {
  return _then(_Sub2ApiUsageGroupStats(
groupId: null == groupId ? _self.groupId : groupId // ignore: cast_nullable_to_non_nullable
as int,groupName: null == groupName ? _self.groupName : groupName // ignore: cast_nullable_to_non_nullable
as String,requests: null == requests ? _self.requests : requests // ignore: cast_nullable_to_non_nullable
as int,totalTokens: null == totalTokens ? _self.totalTokens : totalTokens // ignore: cast_nullable_to_non_nullable
...
mixin _$Sub2ApiUsageDashboardSnapshotRequest {
 ...
 Sub2ApiUsageDashboardQuery get query; bool get includeTrend; bool get includeModelStats; bool get includeGroupStats;
/// Create a copy of Sub2ApiUsageDashboardSnapshotRequest
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Sub2ApiUsageDashboardSnapshotRequestCopyWith<Sub2ApiUsageDashboardSnapshotRequest> get copyWith => _$Sub2ApiUsageDashboardSnapshotRequestCopyWithImpl<Sub2ApiUsageDashboardSnapshotRequest>(this as Sub2ApiUsageDashboardSnapshotRequest, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sub2ApiUsageDashboardSnapshotRequest&&(identical(other.query, query) || other.query == query)&&(identical(other.includeTrend, includeTrend) || other.includeTrend == includeTrend)&&(identical(other.includeModelStats, includeModelStats) || other.includeModelStats == includeModelStats)&&(identical(other.includeGroupStats, includeGroupStats) || other.includeGroupStats == includeGroupStats));
}


@override
int get hashCode => Object.hash(runtimeType,query,includeTrend,includeModelStats,includeGroupStats);
...
abstract mixin class $Sub2ApiUsageDashboardSnapshotRequestCopyWith<$Res>  {
  factory $Sub2ApiUsageDashboardSnapshotRequestCopyWith(Sub2ApiUsageDashboardSnapshotRequest value, $Res Function(Sub2ApiUsageDashboardSnapshotRequest) _then) = _$Sub2ApiUsageDashboardSnapshotRequestCopyWithImpl;
@useResult
$Res call({
 Sub2ApiUsageDashboardQuery query, bool includeTrend, bool includeModelStats, bool includeGroupStats
});
...
/// Create a copy of Sub2ApiUsageDashboardSnapshotRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? query = null,Object? includeTrend = null,Object? includeModelStats = null,Object? includeGroupStats = null,}) {
  return _then(_self.copyWith(
query: null == query ? _self.query : query // ignore: cast_nullable_to_non_nullable
as Sub2ApiUsageDashboardQuery,includeTrend: null == includeTrend ? _self.includeTrend : includeTrend // ignore: cast_nullable_to_non_nullable
...
extension Sub2ApiUsageDashboardSnapshotRequestPatterns on Sub2ApiUsageDashboardSnapshotRequest {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsageDashboardSnapshotRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsageDashboardSnapshotRequest value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsageDashboardSnapshotRequest value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardSnapshotRequest() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Sub2ApiUsageDashboardQuery query,  bool includeTrend,  bool includeModelStats,  bool includeGroupStats)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardSnapshotRequest() when $default != null:
return $default(_that.query,_that.includeTrend,_that.includeModelStats,_that.includeGroupStats);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Sub2ApiUsageDashboardQuery query,  bool includeTrend,  bool includeModelStats,  bool includeGroupStats)  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardSnapshotRequest():
return $default(_that.query,_that.includeTrend,_that.includeModelStats,_that.includeGroupStats);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Sub2ApiUsageDashboardQuery query,  bool includeTrend,  bool includeModelStats,  bool includeGroupStats)?  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardSnapshotRequest() when $default != null:
return $default(_that.query,_that.includeTrend,_that.includeModelStats,_that.includeGroupStats);case _:
  return null;
...
class _Sub2ApiUsageDashboardSnapshotRequest implements Sub2ApiUsageDashboardSnapshotRequest {
  const _Sub2ApiUsageDashboardSnapshotRequest({this.query = const Sub2ApiUsageDashboardQuery(), this.includeTrend = true, this.includeModelStats = true, this.includeGroupStats = false});


@override@JsonKey() final  Sub2ApiUsageDashboardQuery query;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsageDashboardSnapshotRequestCopyWith<_Sub2ApiUsageDashboardSnapshotRequest> get copyWith => __$Sub2ApiUsageDashboardSnapshotRequestCopyWithImpl<_Sub2ApiUsageDashboardSnapshotRequest>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsageDashboardSnapshotRequest&&(identical(other.query, query) || other.query == query)&&(identical(other.includeTrend, includeTrend) || other.includeTrend == includeTrend)&&(identical(other.includeModelStats, includeModelStats) || other.includeModelStats == includeModelStats)&&(identical(other.includeGroupStats, includeGroupStats) || other.includeGroupStats == includeGroupStats));
}
...
/// @nodoc
abstract mixin class _$Sub2ApiUsageDashboardSnapshotRequestCopyWith<$Res> implements $Sub2ApiUsageDashboardSnapshotRequestCopyWith<$Res> {
  factory _$Sub2ApiUsageDashboardSnapshotRequestCopyWith(_Sub2ApiUsageDashboardSnapshotRequest value, $Res Function(_Sub2ApiUsageDashboardSnapshotRequest) _then) = __$Sub2ApiUsageDashboardSnapshotRequestCopyWithImpl;
@override @useResult
$Res call({
 Sub2ApiUsageDashboardQuery query, bool includeTrend, bool includeModelStats, bool includeGroupStats
});
...
@override $Sub2ApiUsageDashboardQueryCopyWith<$Res> get query;
...
/// Create a copy of Sub2ApiUsageDashboardSnapshotRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? query = null,Object? includeTrend = null,Object? includeModelStats = null,Object? includeGroupStats = null,}) {
  return _then(_Sub2ApiUsageDashboardSnapshotRequest(
query: null == query ? _self.query : query // ignore: cast_nullable_to_non_nullable
as Sub2ApiUsageDashboardQuery,includeTrend: null == includeTrend ? _self.includeTrend : includeTrend // ignore: cast_nullable_to_non_nullable
as bool,includeModelStats: null == includeModelStats ? _self.includeModelStats : includeModelStats // ignore: cast_nullable_to_non_nullable
as bool,includeGroupStats: null == includeGroupStats ? _self.includeGroupStats : includeGroupStats // ignore: cast_nullable_to_non_nullable
...
mixin _$Sub2ApiUsageDashboardSnapshot {
 ...
 DateTime get generatedAt; DateTime get startDate; DateTime get endDate; Sub2ApiUsageGranularity get granularity; List<Sub2ApiUsageTrendPoint>? get trend; List<Sub2ApiUsageModelStats>? get models; List<Sub2ApiUsageGroupStats>? get groups;
/// Create a copy of Sub2ApiUsageDashboardSnapshot
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Sub2ApiUsageDashboardSnapshotCopyWith<Sub2ApiUsageDashboardSnapshot> get copyWith => _$Sub2ApiUsageDashboardSnapshotCopyWithImpl<Sub2ApiUsageDashboardSnapshot>(this as Sub2ApiUsageDashboardSnapshot, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sub2ApiUsageDashboardSnapshot&&(identical(other.generatedAt, generatedAt) || other.generatedAt == generatedAt)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.granularity, granularity) || other.granularity == granularity)&&const DeepCollectionEquality().equals(other.trend, trend)&&const DeepCollectionEquality().equals(other.models, models)&&const DeepCollectionEquality().equals(other.groups, groups));
}


@override
int get hashCode => Object.hash(runtimeType,generatedAt,startDate,endDate,granularity,const DeepCollectionEquality().hash(trend),const DeepCollectionEquality().hash(models),const DeepCollectionEquality().hash(groups));
...
abstract mixin class $Sub2ApiUsageDashboardSnapshotCopyWith<$Res>  {
  factory $Sub2ApiUsageDashboardSnapshotCopyWith(Sub2ApiUsageDashboardSnapshot value, $Res Function(Sub2ApiUsageDashboardSnapshot) _then) = _$Sub2ApiUsageDashboardSnapshotCopyWithImpl;
@useResult
$Res call({
 DateTime generatedAt, DateTime startDate, DateTime endDate, Sub2ApiUsageGranularity granularity, List<Sub2ApiUsageTrendPoint>? trend, List<Sub2ApiUsageModelStats>? models, List<Sub2ApiUsageGroupStats>? groups
});
...
/// Create a copy of Sub2ApiUsageDashboardSnapshot
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? generatedAt = null,Object? startDate = null,Object? endDate = null,Object? granularity = null,Object? trend = freezed,Object? models = freezed,Object? groups = freezed,}) {
  return _then(_self.copyWith(
...
as DateTime,endDate: null == endDate ? _self.endDate : endDate // ignore: cast_nullable_to_non_nullable
as DateTime,granularity: null == granularity ? _self.granularity : granularity // ignore: cast_nullable_to_non_nullable
as Sub2ApiUsageGranularity,trend: freezed == trend ? _self.trend : trend // ignore: cast_nullable_to_non_nullable
as List<Sub2ApiUsageTrendPoint>?,models: freezed == models ? _self.models : models // ignore: cast_nullable_to_non_nullable
as List<Sub2ApiUsageModelStats>?,groups: freezed == groups ? _self.groups : groups // ignore: cast_nullable_to_non_nullable
...
extension Sub2ApiUsageDashboardSnapshotPatterns on Sub2ApiUsageDashboardSnapshot {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsageDashboardSnapshot value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsageDashboardSnapshot value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsageDashboardSnapshot value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardSnapshot() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime generatedAt,  DateTime startDate,  DateTime endDate,  Sub2ApiUsageGranularity granularity,  List<Sub2ApiUsageTrendPoint>? trend,  List<Sub2ApiUsageModelStats>? models,  List<Sub2ApiUsageGroupStats>? groups)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardSnapshot() when $default != null:
return $default(_that.generatedAt,_that.startDate,_that.endDate,_that.granularity,_that.trend,_that.models,_that.groups);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime generatedAt,  DateTime startDate,  DateTime endDate,  Sub2ApiUsageGranularity granularity,  List<Sub2ApiUsageTrendPoint>? trend,  List<Sub2ApiUsageModelStats>? models,  List<Sub2ApiUsageGroupStats>? groups)  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardSnapshot():
return $default(_that.generatedAt,_that.startDate,_that.endDate,_that.granularity,_that.trend,_that.models,_that.groups);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime generatedAt,  DateTime startDate,  DateTime endDate,  Sub2ApiUsageGranularity granularity,  List<Sub2ApiUsageTrendPoint>? trend,  List<Sub2ApiUsageModelStats>? models,  List<Sub2ApiUsageGroupStats>? groups)?  $default,) {final _that = this;
switch (_that) {
case _Sub2ApiUsageDashboardSnapshot() when $default != null:
return $default(_that.generatedAt,_that.startDate,_that.endDate,_that.granularity,_that.trend,_that.models,_that.groups);case _:
  return null;
...
class _Sub2ApiUsageDashboardSnapshot implements Sub2ApiUsageDashboardSnapshot {
  const _Sub2ApiUsageDashboardSnapshot({required this.generatedAt, required this.startDate, required this.endDate, required this.granularity, final  List<Sub2ApiUsageTrendPoint>? trend, final  List<Sub2ApiUsageModelStats>? models, final  List<Sub2ApiUsageGroupStats>? groups}): _trend = trend,_models = models,_groups = groups;
...
@override List<Sub2ApiUsageTrendPoint>? get trend {
  final value = _trend;
  if (value == null) return null;
...
@override List<Sub2ApiUsageGroupStats>? get groups {
  final value = _groups;
  if (value == null) return null;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsageDashboardSnapshotCopyWith<_Sub2ApiUsageDashboardSnapshot> get copyWith => __$Sub2ApiUsageDashboardSnapshotCopyWithImpl<_Sub2ApiUsageDashboardSnapshot>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsageDashboardSnapshot&&(identical(other.generatedAt, generatedAt) || other.generatedAt == generatedAt)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.granularity, granularity) || other.granularity == granularity)&&const DeepCollectionEquality().equals(other._trend, _trend)&&const DeepCollectionEquality().equals(other._models, _models)&&const DeepCollectionEquality().equals(other._groups, _groups));
}


@override
int get hashCode => Object.hash(runtimeType,generatedAt,startDate,endDate,granularity,const DeepCollectionEquality().hash(_trend),const DeepCollectionEquality().hash(_models),const DeepCollectionEquality().hash(_groups));
...
/// @nodoc
abstract mixin class _$Sub2ApiUsageDashboardSnapshotCopyWith<$Res> implements $Sub2ApiUsageDashboardSnapshotCopyWith<$Res> {
  factory _$Sub2ApiUsageDashboardSnapshotCopyWith(_Sub2ApiUsageDashboardSnapshot value, $Res Function(_Sub2ApiUsageDashboardSnapshot) _then) = __$Sub2ApiUsageDashboardSnapshotCopyWithImpl;
@override @useResult
$Res call({
 DateTime generatedAt, DateTime startDate, DateTime endDate, Sub2ApiUsageGranularity granularity, List<Sub2ApiUsageTrendPoint>? trend, List<Sub2ApiUsageModelStats>? models, List<Sub2ApiUsageGroupStats>? groups
});
...
/// Create a copy of Sub2ApiUsageDashboardSnapshot
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? generatedAt = null,Object? startDate = null,Object? endDate = null,Object? granularity = null,Object? trend = freezed,Object? models = freezed,Object? groups = freezed,}) {
  return _then(_Sub2ApiUsageDashboardSnapshot(
generatedAt: null == generatedAt ? _self.generatedAt : generatedAt // ignore: cast_nullable_to_non_nullable
as DateTime,startDate: null == startDate ? _self.startDate : startDate // ignore: cast_nullable_to_non_nullable
as DateTime,endDate: null == endDate ? _self.endDate : endDate // ignore: cast_nullable_to_non_nullable
as DateTime,granularity: null == granularity ? _self.granularity : granularity // ignore: cast_nullable_to_non_nullable
as Sub2ApiUsageGranularity,trend: freezed == trend ? _self._trend : trend // ignore: cast_nullable_to_non_nullable
as List<Sub2ApiUsageTrendPoint>?,models: freezed == models ? _self._models : models // ignore: cast_nullable_to_non_nullable
as List<Sub2ApiUsageModelStats>?,groups: freezed == groups ? _self._groups : groups // ignore: cast_nullable_to_non_nullable
as List<Sub2ApiUsageGroupStats>?,
  ));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$Sub2ApiUsageApiKeyStatsCopyWith<Sub2ApiUsageApiKeyStats> get copyWith => _$Sub2ApiUsageApiKeyStatsCopyWithImpl<Sub2ApiUsageApiKeyStats>(this as Sub2ApiUsageApiKeyStats, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Sub2ApiUsageApiKeyStats&&(identical(other.apiKeyId, apiKeyId) || other.apiKeyId == apiKeyId)&&(identical(other.todayActualCost, todayActualCost) || other.todayActualCost == todayActualCost)&&(identical(other.totalActualCost, totalActualCost) || other.totalActualCost == totalActualCost));
}
...
abstract mixin class $Sub2ApiUsageApiKeyStatsCopyWith<$Res>  {
  factory $Sub2ApiUsageApiKeyStatsCopyWith(Sub2ApiUsageApiKeyStats value, $Res Function(Sub2ApiUsageApiKeyStats) _then) = _$Sub2ApiUsageApiKeyStatsCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Sub2ApiUsageApiKeyStats value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Sub2ApiUsageApiKeyStats value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Sub2ApiUsageApiKeyStats value)?  $default,){
final _that = this;
switch (_that) {
case _Sub2ApiUsageApiKeyStats() when $default != null:
return $default(_that);case _:
...
class _Sub2ApiUsageApiKeyStats implements Sub2ApiUsageApiKeyStats {
  const _Sub2ApiUsageApiKeyStats({required this.apiKeyId, required this.todayActualCost, required this.totalActualCost});
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$Sub2ApiUsageApiKeyStatsCopyWith<_Sub2ApiUsageApiKeyStats> get copyWith => __$Sub2ApiUsageApiKeyStatsCopyWithImpl<_Sub2ApiUsageApiKeyStats>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Sub2ApiUsageApiKeyStats&&(identical(other.apiKeyId, apiKeyId) || other.apiKeyId == apiKeyId)&&(identical(other.todayActualCost, todayActualCost) || other.todayActualCost == todayActualCost)&&(identical(other.totalActualCost, totalActualCost) || other.totalActualCost == totalActualCost));
}
...
/// @nodoc
abstract mixin class _$Sub2ApiUsageApiKeyStatsCopyWith<$Res> implements $Sub2ApiUsageApiKeyStatsCopyWith<$Res> {
  factory _$Sub2ApiUsageApiKeyStatsCopyWith(_Sub2ApiUsageApiKeyStats value, $Res Function(_Sub2ApiUsageApiKeyStats) _then) = __$Sub2ApiUsageApiKeyStatsCopyWithImpl;
@override @useResult
$Res call({
 int apiKeyId, Sub2ApiDecimal todayActualCost, Sub2ApiDecimal totalActualCost
});
...
@override @pragma('vm:prefer-inline') $Res call({Object? apiKeyId = null,Object? todayActualCost = null,Object? totalActualCost = null,}) {
  return _then(_Sub2ApiUsageApiKeyStats(
apiKeyId: null == apiKeyId ? _self.apiKeyId : apiKeyId // ignore: cast_nullable_to_non_nullable
as int,todayActualCost: null == todayActualCost ? _self.todayActualCost : todayActualCost // ignore: cast_nullable_to_non_nullable
as Sub2ApiDecimal,totalActualCost: null == totalActualCost ? _self.totalActualCost : totalActualCost // ignore: cast_nullable_to_non_nullable
as Sub2ApiDecimal,
