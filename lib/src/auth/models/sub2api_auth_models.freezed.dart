...
mixin _$Sub2ApiAuthenticatedUser {
  ...
  $Sub2ApiAuthenticatedUserCopyWith<Sub2ApiAuthenticatedUser> get copyWith =>
      _$Sub2ApiAuthenticatedUserCopyWithImpl<Sub2ApiAuthenticatedUser>(
        this as Sub2ApiAuthenticatedUser,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is Sub2ApiAuthenticatedUser &&
...
abstract mixin class $Sub2ApiAuthenticatedUserCopyWith<$Res> {
  factory $Sub2ApiAuthenticatedUserCopyWith(
    Sub2ApiAuthenticatedUser value,
    $Res Function(Sub2ApiAuthenticatedUser) _then,
  ) = _$Sub2ApiAuthenticatedUserCopyWithImpl;
  @useResult
  $Res call({int id, String email, String role, String username});
}
...
extension Sub2ApiAuthenticatedUserPatterns on Sub2ApiAuthenticatedUser {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Sub2ApiAuthenticatedUser value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String email, String role, String username)?
    $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Sub2ApiAuthenticatedUser() when $default != null:
        return $default(_that.id, _that.email, _that.role, _that.username);
      case _:
        return orElse();
    }
  }
...
class _Sub2ApiAuthenticatedUser implements Sub2ApiAuthenticatedUser {
  const _Sub2ApiAuthenticatedUser({
    required this.id,
    required this.email,
    required this.role,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$Sub2ApiAuthenticatedUserCopyWith<_Sub2ApiAuthenticatedUser> get copyWith =>
      __$Sub2ApiAuthenticatedUserCopyWithImpl<_Sub2ApiAuthenticatedUser>(
        this,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _Sub2ApiAuthenticatedUser &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.email, email) || other.email == email) &&
            (identical(other.role, role) || other.role == role) &&
            (identical(other.username, username) ||
...
/// @nodoc
abstract mixin class _$Sub2ApiAuthenticatedUserCopyWith<$Res>
    implements $Sub2ApiAuthenticatedUserCopyWith<$Res> {
  factory _$Sub2ApiAuthenticatedUserCopyWith(
    _Sub2ApiAuthenticatedUser value,
    $Res Function(_Sub2ApiAuthenticatedUser) _then,
  ) = __$Sub2ApiAuthenticatedUserCopyWithImpl;
  @override
  @useResult
  $Res call({int id, String email, String role, String username});
}
...
mixin _$Sub2ApiCurrentUser {
  Sub2ApiUserAccountSnapshot get account;
  String get runMode;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $Sub2ApiCurrentUserCopyWith<Sub2ApiCurrentUser> get copyWith =>
      _$Sub2ApiCurrentUserCopyWithImpl<Sub2ApiCurrentUser>(
        this as Sub2ApiCurrentUser,
        _$identity,
      );
...
abstract mixin class $Sub2ApiCurrentUserCopyWith<$Res> {
  factory $Sub2ApiCurrentUserCopyWith(
    Sub2ApiCurrentUser value,
    $Res Function(Sub2ApiCurrentUser) _then,
  ) = _$Sub2ApiCurrentUserCopyWithImpl;
  @useResult
  $Res call({Sub2ApiUserAccountSnapshot account, String runMode});
...
class _$Sub2ApiCurrentUserCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? account = null, Object? runMode = null}) {
    return _then(
      _self.copyWith(
        account: null == account
            ? _self.account
            : account // ignore: cast_nullable_to_non_nullable
                  as Sub2ApiUserAccountSnapshot,
...
extension Sub2ApiCurrentUserPatterns on Sub2ApiCurrentUser {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Sub2ApiCurrentUser value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(Sub2ApiUserAccountSnapshot account, String runMode)?
    $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Sub2ApiCurrentUser() when $default != null:
        return $default(_that.account, _that.runMode);
      case _:
        return orElse();
    }
  }
...
class _Sub2ApiCurrentUser extends Sub2ApiCurrentUser {
  const _Sub2ApiCurrentUser({required this.account, required this.runMode})
    : super._();

  @override
  final Sub2ApiUserAccountSnapshot account;
  @override
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$Sub2ApiCurrentUserCopyWith<_Sub2ApiCurrentUser> get copyWith =>
      __$Sub2ApiCurrentUserCopyWithImpl<_Sub2ApiCurrentUser>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _Sub2ApiCurrentUser &&
            (identical(other.account, account) || other.account == account) &&
            (identical(other.runMode, runMode) || other.runMode == runMode));
  }
...
/// @nodoc
abstract mixin class _$Sub2ApiCurrentUserCopyWith<$Res>
    implements $Sub2ApiCurrentUserCopyWith<$Res> {
  factory _$Sub2ApiCurrentUserCopyWith(
    _Sub2ApiCurrentUser value,
    $Res Function(_Sub2ApiCurrentUser) _then,
  ) = __$Sub2ApiCurrentUserCopyWithImpl;
  @override
  @useResult
  $Res call({Sub2ApiUserAccountSnapshot account, String runMode});
...
mixin _$Sub2ApiLoginResult {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is Sub2ApiLoginResult);
  }
...
class $Sub2ApiLoginResultCopyWith<$Res> {
  $Sub2ApiLoginResultCopyWith(
    Sub2ApiLoginResult _,
    $Res Function(Sub2ApiLoginResult) __,
  );
}
...
extension Sub2ApiLoginResultPatterns on Sub2ApiLoginResult {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>({
    TResult Function(Sub2ApiAuthenticated value)? authenticated,
    TResult Function(Sub2ApiTwoFactorRequired value)? twoFactorRequired,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      ...
      case Sub2ApiTwoFactorRequired() when twoFactorRequired != null:
  ...
  @optionalTypeArgs
  TResult map<TResult extends Object?>({
    required TResult Function(Sub2ApiAuthenticated value) authenticated,
    required TResult Function(Sub2ApiTwoFactorRequired value) twoFactorRequired,
  }) {
    final _that = this;
    switch (_that) {
      case Sub2ApiAuthenticated():
        return authenticated(_that);
      case Sub2ApiTwoFactorRequired():
        return twoFactorRequired(_that);
    }
  }
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>({
    TResult Function(Sub2ApiAuthenticatedUser user, Sub2ApiSession session)?
    authenticated,
    TResult Function(
...
class Sub2ApiAuthenticated implements Sub2ApiLoginResult {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $Sub2ApiAuthenticatedCopyWith<Sub2ApiAuthenticated> get copyWith =>
      _$Sub2ApiAuthenticatedCopyWithImpl<Sub2ApiAuthenticated>(
        this,
        _$identity,
      );
...
/// @nodoc
abstract mixin class $Sub2ApiAuthenticatedCopyWith<$Res>
    implements $Sub2ApiLoginResultCopyWith<$Res> {
  factory $Sub2ApiAuthenticatedCopyWith(
    Sub2ApiAuthenticated value,
    $Res Function(Sub2ApiAuthenticated) _then,
  ) = _$Sub2ApiAuthenticatedCopyWithImpl;
  @useResult
  $Res call({Sub2ApiAuthenticatedUser user, Sub2ApiSession session});
...
class Sub2ApiTwoFactorRequired implements Sub2ApiLoginResult {
  const Sub2ApiTwoFactorRequired({
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $Sub2ApiTwoFactorRequiredCopyWith<Sub2ApiTwoFactorRequired> get copyWith =>
      _$Sub2ApiTwoFactorRequiredCopyWithImpl<Sub2ApiTwoFactorRequired>(
        this,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is Sub2ApiTwoFactorRequired &&
...
/// @nodoc
abstract mixin class $Sub2ApiTwoFactorRequiredCopyWith<$Res>
    implements $Sub2ApiLoginResultCopyWith<$Res> {
  factory $Sub2ApiTwoFactorRequiredCopyWith(
    Sub2ApiTwoFactorRequired value,
    $Res Function(Sub2ApiTwoFactorRequired) _then,
  ) = _$Sub2ApiTwoFactorRequiredCopyWithImpl;
  @useResult
  $Res call({
    Sub2ApiTwoFactorTemporaryToken temporaryToken,
    String userEmailMasked,
...
class _$Sub2ApiTwoFactorRequiredCopyWithImpl<$Res>
  ...
  /// with the given fields replaced by the non-null parameter values.
  @pragma('vm:prefer-inline')
  $Res call({Object? temporaryToken = null, Object? userEmailMasked = null}) {
    return _then(
