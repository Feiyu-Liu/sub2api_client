...
part of 'passkey_wire_service.dart';
...
class _PasskeyWireService implements PasskeyWireService {
  _PasskeyWireService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<Object?>> finishRegistration(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/api/v1/user/passkeys/register/finish',
    )..data = _data;
    final _result = await _dio.fetch<Object>(_options);
    late Object? _value;
    try {
